namespace FractalSpace
{
  ...
  void make_me_a_galaxy(int FractalRank,int numbers,double total_mass,double G,
			deque <double>& xpos,deque <double>& ypos,deque <double>& zpos,
			deque <double>& xvel,deque <double>& yvel,deque <double>& zvel);
  ...
  void super_groups(Fractal_Memory& mem,vector <Group*>& groups,const int level,
		    ...
		    vector<bool>& IAmIn);
  template <class ForwardIterator>
  void take_a_leap_isol(Fractal_Memory* PFM,double G,
