...
//----------------------------------------------------------------------------//
#ifndef __Spheral_SphericalBiCubicSplineKernelOslo_hh__
#define __Spheral_SphericalBiCubicSplineKernelOslo_hh__
...
public:
  ...
  SphericalBiCubicSplineKernelOslo(const unsigned numKernel = 200u);
  SphericalBiCubicSplineKernelOslo(const SphericalBiCubicSplineKernelOslo& rhs);

  // Destructor.
  virtual ~SphericalBiCubicSplineKernelOslo();

  // Assignment.
  SphericalBiCubicSplineKernelOslo& operator=(const SphericalBiCubicSplineKernelOslo& rhs);

  // Comparisons
  bool operator==(const SphericalBiCubicSplineKernelOslo& rhs) const;
...
#include "SphericalBiCubicSplineKernelOsloInline.hh"
