...
#include "CSPH/computeCSPHCorrections2.hh"
...
inline
void
CSPH2KernelAndGradient1d(const KernelSpace::TableKernel<Dim<1> >& W,
                        const Dim<1>::Vector& rij,
                        const Dim<1>::Vector& etaj,
                        const Dim<1>::SymTensor& Hj,
                        const Dim<1>::Scalar& Hdetj,
                        const Dim<1>::Scalar& Ai,
                        const Dim<1>::Vector& Bi,
                        const Dim<1>::Tensor& Mi,
                        Dim<1>::Scalar* WCSPH,
                        Dim<1>::Scalar* gradWSPH,
                        Dim<1>::Vector& gradWCSPH) {
  return CSPHKernelAndGradient(W, rij, etaj, Hj, Hdetj, Ai, Bi, Mi, *WCSPH, *gradWSPH, gradWCSPH);
}

inline
void
CSPH2KernelAndGradient2d(const KernelSpace::TableKernel<Dim<2> >& W,
                        const Dim<2>::Vector& rij,
                        const Dim<2>::Vector& etaj,
                        const Dim<2>::SymTensor& Hj,
                        const Dim<2>::Scalar& Hdetj,
...
inline
void
CSPH2KernelAndGradient3d(const KernelSpace::TableKernel<Dim<3> >& W,
                        const Dim<3>::Vector& rij,
                        const Dim<3>::Vector& etaj,
                        const Dim<3>::SymTensor& Hj,
                        const Dim<3>::Scalar& Hdetj,
