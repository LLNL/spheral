...
""" % {"dim" : dim, "ndim" : ndim})
    ...
    def generateTableKernelBindings(self, x, ndim):
        ...
        # Attributes.
        x.add_instance_attribute("kernelValues", "vector_of_double", getter="kernelValues", is_const=True)
        x.add_instance_attribute("gradValues", "vector_of_double", getter="gradValues", is_const=True)
        x.add_instance_attribute("grad2Values", "vector_of_double", getter="grad2Values", is_const=True)
