...
''' % {"dim" : dim})
        ...
        if 2 in self.dims:
            self.addMonaghanGingoldViscosityRZMethods()
    ...
    #---------------------------------------------------------------------------
    # Add methods to the MonaghanGingoldViscosityRZ.
    #---------------------------------------------------------------------------
    def addMonaghanGingoldViscosityRZMethods(self):

        x = self.MonaghanGingoldViscosityRZ
