...
#pragma omp critical
  ...
  // {
  //   tpre = allReduce(unsigned(tpre), SPHERAL_MPI_SUM) / Process::getTotalNumberOfProcesses() / CLOCKS_PER_SEC;
  //   tmaster = allReduce(unsigned(tmaster), SPHERAL_MPI_SUM) / Process::getTotalNumberOfProcesses() / CLOCKS_PER_SEC;
  //   trefine = allReduce(unsigned(trefine), SPHERAL_MPI_SUM) / Process::getTotalNumberOfProcesses() / CLOCKS_PER_SEC;
  //   twalk = allReduce(unsigned(twalk), SPHERAL_MPI_SUM) / Process::getTotalNumberOfProcesses() / CLOCKS_PER_SEC;
