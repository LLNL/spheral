...
class CurrentDensityUpdatePolicy:
   public Spheral::UpdatePolicyBase<Dim<3>, FieldSpace::Field<Dim<3>, Dim<3>::Vector> >
{
   public:
   ...
   CurrentDensityUpdatePolicy(const KernelSpace::TableKernel<Dim<3> >& kernel,
   ...
   //! Equivalence.
   virtual bool operator==(const Spheral::UpdatePolicyBase<Dim<3>, FieldSpace::Field<Dim<3>, Dim<3>::Vector> >& rhs) const;
   ...
   const DataBaseSpace::DataBase<Dim<3> >& mDataBase;
