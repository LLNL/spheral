...
//----------------------------------------------------------------------------//
#ifndef __Spheral_FSISPHHydroBaseRZ_hh__
#define __Spheral_FSISPHHydroBaseRZ_hh__
...
class FSISPHHydroBaseRZ: public FSISPHHydroBase<Dim<2> > {
...
public:
  ...
  // Constructors.
  FSISPHHydroBaseRZ(const SmoothingScaleBase<Dimension>& smoothingScaleMethod,
  ...
  virtual std::string label() const override { return "FSISPHHydroBaseRZ" ; }
  //****************************************************************************
...
private:
  ...
  FSISPHHydroBaseRZ();
  FSISPHHydroBaseRZ(const FSISPHHydroBaseRZ&);
  FSISPHHydroBaseRZ& operator=(const FSISPHHydroBaseRZ&);
};
