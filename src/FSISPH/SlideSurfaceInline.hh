...
pairwiseInterfaceSmoothness(const typename Dimension::Scalar smoothnessi,
    ...
    //const auto ssijMax = ( 1.0 -  20.0*std::min(std::max(0.97-ssMax,0.0),0.05) ); // ramps down 0.97->0.87
    //const auto ssijMin = ( 1.0 -   10.0*std::min(std::max(0.95-ssMin,0.0),0.10) );  // ramps down 0.90->0.70
    return (1.0 - 10.0*std::min(std::max(0.95-smoothnessi*smoothnessj,0.0),0.10) );      
