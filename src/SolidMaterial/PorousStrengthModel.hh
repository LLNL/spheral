...
public:
  ...
  virtual double shearModulus(const double density,
                              ...
                              const double pressure) const { VERIFY2(false, "PorousStrengthModel forbids non-Field shearModulus"); return 0.0; }

  virtual double yieldStrength(const double density,
                               const double specificThermalEnergy,
                               const double pressure,
                               const double plasticStrain,
                               const double plasticStrainRate) const { VERIFY2(false, "PorousStrengthModel forbids non-Field yieldStrength"); return 0.0; }
