namespace FractalSpace
{
  ...
  void mpi_end();
  void mpi_init();
  void mpi_node_number(int& spam);
  void mpi_nodes_total(int& spam);
  void neighbor_easy(vector <Point*>& p);
  void neighbors_nina(Point& point, vector <Point*>& adj);
  void node_end();
  void node_start(Fractal& fractal,Fractal_Memory& fractal_memory);
  void node_init();
  ...
  void receive_groups(Fractal& fractal,Fractal_Memory& fractal_memory,Misc& misc);
  void receive_potential(Group& group,Fractal& fractal,Fractal_Memory& fractal_memory,Misc& misc);
  void send_groups(Group& group,Fractal& fractal,Fractal_Memory& fractal_memory,Misc& misc);
  ...
  void split_high_groups(Group& group,Fractal& fractal,Fractal_Memory& fractal_memory,Misc& misc);
  ...
  int where_3(const int& i, const int& j, const int& k, const int& m,const bool& p);
