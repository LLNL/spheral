...
namespace FractalSpace
{
  void halo_force(Fractal& frac)
  {
    ...
    sort(frac.particle_list_sorted.begin(),frac.particle_list_sorted.end(),z_compare);
  ...
  bool z_compare(Particle* par1,Particle* par2)
  {
    return par1->get_pos(2) <= par2->get_pos(2);
  }
}
