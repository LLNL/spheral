...
namespace FractalSpace
{
  class Fractal
  {
    ...
    vector <int> BoxReal;
    /*
    MPI::Comm FractalComm;
    MPI::Comm TreeComm;
    MPI::Comm FftComm;
    MPI::Comm SolverComm;
    MPI::Comm ExtraComm;
    */
    int NumberFractalNodes;
    int NumberTreeNodes;
    int NumberFftNodes;
    int NumberSolverNodes;
    int NumberExtraNodes;
    int RankFractalNode;
    int RankTreeNode;
    int RankFftNode;
    int RankSolverNode;
    int RankExtraNode;
    bool MasterFractalNode;
    bool MasterTreeNode;
    bool MasterFftNode;
    bool MasterSolverNode;
    bool MasterExtraNode;
    bool IamaFractalNode;
    bool IamaTreeNode;
    bool IamaFftNode;
    bool IamaSolverNode;
    bool IamaExtraNode;
  ...
  public:
    ...
    Fractal():
      ...
      RankSolverNode(0),
      RankExtraNode(0),
      MasterFractalNode(true),
      MasterTreeNode(true),
      MasterFftNode(true),
      MasterSolverNode(true),
      MasterExtraNode(true),
      IamaFractalNode(true),
      IamaTreeNode(true),
      IamaFftNode(true),
      IamaSolverNode(true),
      IamaExtraNode(true),
      ...
      omega_fraction(2.0/3.0)
    {
      ...
      Box[2]=-2;
      Box[4]=-2;
      BoxReal.assign(6,grid_length-1);
      BoxReal[0]=0;
      BoxReal[2]=0;
      BoxReal[4]=0;
  //
  ...
  //
    ...
    void getBoxReal(vector <int>& BB)
    {
      BB=BoxReal;
    }
    void setNumberFractalNodes(const int& n)
    {
      NumberFractalNodes=n;
    }
    void setNumberTreeNodes(const int& n)
    {
      NumberTreeNodes=n;
    }
    void setNumberFftNodes(const int& n)
    {
      NumberFftNodes=n;
    }
    void setNumberSolverNodes(const int& n)
    {
      NumberSolverNodes=n;
    }
    void setNumberExtraNodes(const int& n)
    {
      NumberExtraNodes=n;
    }
    void setRankFractalNode(const int& n)
    {
      RankFractalNode=n;
    }
    void setRankTreeNode(const int& n)
    {
      RankTreeNode=n;
    }
    void setRankFftNode(const int& n)
    {
      RankFftNode=n;
    }
    void setRankSolverNode(const int& n)
    {
      RankSolverNode=n;
    }
    void setRankExtraNode(const int& n)
    {
      RankExtraNode=n;
    }
    void setMasterFractalNode(const bool& m)
    {
      MasterFractalNode=m;
    }
    void setMasterTreeNode(const bool& m)
    {
      MasterTreeNode=m;
    }
    void setMasterFftNode(const bool& m)
    {
      MasterFftNode=m;
    }
    void setMasterSolverNode(const bool& m)
    {
      MasterSolverNode=m;
    }
    void setMasterExtraNode(const bool& m)
    {
      MasterExtraNode=m;
    }
    void setIamaFractalNode(const bool& m)
    {
      IamaFractalNode=m;
    }
    void setIamaTreeNode(const bool& m)
    {
      IamaTreeNode=m;
    }
    void setIamaFftNode(const bool& m)
    {
      IamaFftNode=m;
    }
    void setIamaSolverNode(const bool& m)
    {
      IamaSolverNode=m;
    }
    void setIamaExtraNode(const bool& m)
    {
      IamaExtraNode=m;
    }
    int getNumberFractalNodes()
    {
      return NumberFractalNodes;
    }
    int getNumberTreeNodes()
    {
      return NumberTreeNodes;
    }
    int getNumberFftNodes()
    {
      return NumberFftNodes;
    }
    int getNumberSolverNodes()
    {
      return NumberSolverNodes;
    }
    int getNumberExtraNodes()
    {
      return NumberExtraNodes;
    }
    int getRankFractalNode()
    {
      return RankFractalNode;
    }
    int getRankTreeNode()
    {
      return RankTreeNode;
    ...
    int getRankSolverNode()
    {
      return RankSolverNode;
    }
    int getRankExtraNode()
    {
      return RankExtraNode;
    }
    bool getMasterFractalNode()
    {
      return MasterFractalNode;
    }
    bool getMasterTreeNode()
    {
      return MasterTreeNode;
    }
    bool getMasterFftNode()
    {
      return MasterFftNode;
    }
    bool getMasterSolverNode()
    {
      return MasterSolverNode;
    }
    bool getMasterExtraNode()
    {
      return MasterExtraNode;
    }
    bool amIaFractalNode()
    {
      return IamaFractalNode;
    }
    bool amIaTreeNode()
    {
      return IamaTreeNode;
    ...
    bool amIaSolverNode()
    {
      return IamaSolverNode;
    }
    bool amIaExtraNode()
    {
      return IamaExtraNode;
    }
