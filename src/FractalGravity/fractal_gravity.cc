...
namespace FractalSpace
{
  ...
  void fractal_gravity(Fractal& fractal,Fractal_Memory& fractal_memory)
  {
    ...
    //--------------------------------------------------------------------------
    // Generating the first chain of groups. The head group is at the head of the chain.
    // It is OK to start the Poisson solving of this chain immediately
    //--------------------------------------------------------------------------
	...
	for(vector <Group*>::const_iterator group_itr=fractal_memory.all_groups[level].begin();
	    group_itr!=fractal_memory.all_groups[level].end();group_itr++)
	  {
		...
		//--------------------------------------------------------------------------
		// The first new group generated from the group becomes the new tail node in the chain
		//--------------------------------------------------------------------------
