...
c     
      adj(1,1,1)=max(
     >  g_3(point,up_x,up_y,up_z),
     >  g_3(point,up_x,up_z,up_y),
     >  g_3(point,up_y,up_z,up_x),
     >  g_3(point,up_y,up_x,up_z),
     >  g_3(point,up_z,up_x,up_y),
     >  g_3(point,up_z,up_y,up_x))
      adj(-1,1,1)=max(
     >  g_3(point,down_x,up_y,up_z),
     >  g_3(point,down_x,up_z,up_y),
     >  g_3(point,up_y,up_z,down_x),
     >  g_3(point,up_y,down_x,up_z),
     >  g_3(point,up_z,down_x,up_y),
     >  g_3(point,up_z,up_y,down_x))
      adj(1,-1,1)=max(
     >  g_3(point,up_x,down_y,up_z),
     >  g_3(point,up_x,up_z,down_y),
     >  g_3(point,down_y,up_z,up_x),
     >  g_3(point,down_y,up_x,up_z),
     >  g_3(point,up_z,up_x,down_y),
     >  g_3(point,up_z,down_y,up_x))
      adj(-1,-1,1)=max(
     >  g_3(point,down_x,down_y,up_z),
     >  g_3(point,down_x,up_z,down_y),
     >  g_3(point,down_y,up_z,down_x),
     >  g_3(point,down_y,down_x,up_z),
     >  g_3(point,up_z,down_x,down_y),
     >  g_3(point,up_z,down_y,down_x))
c     
      adj(1,1,-1)=max(
     >  g_3(point,up_x,up_y,down_z),
     >  g_3(point,up_x,down_z,up_y),
     >  g_3(point,up_y,down_z,up_x),
     >  g_3(point,up_y,up_x,down_z),
     >  g_3(point,down_z,up_x,up_y),
     >  g_3(point,down_z,up_y,up_x))
      adj(-1,1,-1)=max(
     >  g_3(point,down_x,up_y,down_z),
     >  g_3(point,down_x,down_z,up_y),
     >  g_3(point,up_y,down_z,down_x),
     >  g_3(point,up_y,down_x,down_z),
     >  g_3(point,down_z,down_x,up_y),
     >  g_3(point,down_z,up_y,down_x))
      adj(1,-1,-1)=max(
     >  g_3(point,up_x,down_y,down_z),
     >  g_3(point,up_x,down_z,down_y),
     >  g_3(point,down_y,down_z,up_x),
     >  g_3(point,down_y,up_x,down_z),
     >  g_3(point,down_z,up_x,down_y),
     >  g_3(point,down_z,down_y,up_x))
      adj(-1,-1,-1)=max(
     >  g_3(point,down_x,down_y,down_z),
     >  g_3(point,down_x,down_z,down_y),
     >  g_3(point,down_y,down_z,down_x),
     >  g_3(point,down_y,down_x,down_z),
     >  g_3(point,down_z,down_x,down_y),
     >  g_3(point,down_z,down_y,down_x))
c     
c     do k=-1,1
c     do j=-1,1
c     do i=-1,1
c     write(43,*)i,j,k,point,adj(i,j,k)
c     end do
c     end do
c     end do
      return
