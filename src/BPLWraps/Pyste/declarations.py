...
# JMO begin
#==============================================================================
# Dumb little function to map unfortunate C++ names to a single value.
# Required to handle some strangeness with the latest gcc_xml & pyste.  >:(
# JMO Thu Nov  4 22:45:55 PST 2004
#==============================================================================
def mapToCommonName(name):
    if name == "basic_string<char,std::char_traits<char>,std::allocator<char> >":
        return "string"
    if name is None:
        return 'unnamed'
    return name
...
class Declaration(object):
    ...
    def __init__(self, name, namespace):
        ...
        '''
# JMO begin
        self.name = mapToCommonName(name)
# JMO end
