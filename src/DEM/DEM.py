...
# HerzianDEMFactoryString = """
# class %(classname)s%(dim)s(HerzianDEM%(dim)s):
...
#         HerzianDEM%(dim)s.__init__(self,
#                                    dataBase,
#                                    YoungsModulus,
#                                    restitutionCoefficient,
#                                    stepsPerCollision,
...
#-------------------------------------------------------------------------------
# Hezian DEM helper class
#-------------------------------------------------------------------------------
def HerzianDEM(dataBase,
               YoungsModulus,
               restitutionCoefficient,
               stepsPerCollision = 25,
               xmin = (-1e100, -1e100, -1e100),
    ...
    Constructor = eval("HerzianDEM%id" % ndim)
