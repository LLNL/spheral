...
#include "config.hh"
#include "SPH/computePSPHCorrections.cc"
#include "Geometry/Dimension.hh"

namespace Spheral {
#if defined(SPHERAL_ENABLE_1D)
  template void computePSPHCorrections(const ConnectivityMap<Dim<1> >&,
  ...
  template void computePSPHCorrections(const ConnectivityMap<Dim<2> >&,
  ...
  template void computePSPHCorrections(const ConnectivityMap<Dim<3> >&,
