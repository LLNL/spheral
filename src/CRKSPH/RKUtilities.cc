...
evaluateRKHessian<Dim<3>>(const TableKernel<Dim<3>>& kernel,
  ...
  case CRKOrder::CubicOrder:
    for (auto k1 = 0; k1 < dim; ++k1) {
      for (auto k2 = 0; k2 < dim; ++k2) {
        hess[3*k1 + k2] = w*dda[3*k1 + k2] + da[k2]*dw[k1] + da[k1]*dw[k2] + ddw[3*k1 + k2]*(a + b[0]*g[0] + c[0]*std::pow(g[0],2) + d[0]*std::pow(g[0],3) + b[1]*g[1] + c[1]*g[0]*g[1] + c[3]*g[0]*g[1] + d[1]*std::pow(g[0],2)*g[1] + d[3]*std::pow(g[0],2)*g[1] + d[9]*std::pow(g[0],2)*g[1] + c[4]*std::pow(g[1],2) + d[4]*g[0]*std::pow(g[1],2) + d[10]*g[0]*std::pow(g[1],2) + d[12]*g[0]*std::pow(g[1],2) + d[13]*std::pow(g[1],3) + b[2]*g[2] + c[2]*g[0]*g[2] + c[6]*g[0]*g[2] + d[2]*std::pow(g[0],2)*g[2] + d[6]*std::pow(g[0],2)*g[2] + d[18]*std::pow(g[0],2)*g[2] + c[5]*g[1]*g[2] + c[7]*g[1]*g[2] + d[5]*g[0]*g[1]*g[2] + d[7]*g[0]*g[1]*g[2] + d[11]*g[0]*g[1]*g[2] + d[15]*g[0]*g[1]*g[2] + d[19]*g[0]*g[1]*g[2] + d[21]*g[0]*g[1]*g[2] + d[14]*std::pow(g[1],2)*g[2] + d[16]*std::pow(g[1],2)*g[2] + d[22]*std::pow(g[1],2)*g[2] + c[8]*std::pow(g[2],2) + d[8]*g[0]*std::pow(g[2],2) + d[20]*g[0]*std::pow(g[2],2) + d[24]*g[0]*std::pow(g[2],2) + d[17]*g[1]*std::pow(g[2],2) + d[23]*g[1]*std::pow(g[2],2) + d[25]*g[1]*std::pow(g[2],2) + d[26]*std::pow(g[2],3)) + dw[k2]*g[0]*db[k1] + dw[k1]*g[0]*db[k2] + dw[k2]*g[1]*db[3 + k1] + dw[k1]*g[1]*db[3 + k2] + dw[k2]*g[2]*db[6 + k1] + dw[k1]*g[2]*db[6 + k2] + dw[k2]*std::pow(g[0],2)*dc[k1] + dw[k1]*std::pow(g[0],2)*dc[k2] + dw[k2]*g[0]*g[1]*dc[3 + k1] + dw[k1]*g[0]*g[1]*dc[3 + k2] + dw[k2]*g[0]*g[2]*dc[6 + k1] + dw[k1]*g[0]*g[2]*dc[6 + k2] + dw[k2]*g[0]*g[1]*dc[9 + k1] + dw[k1]*g[0]*g[1]*dc[9 + k2] + dw[k2]*std::pow(g[1],2)*dc[12 + k1] + dw[k1]*std::pow(g[1],2)*dc[12 + k2] + dw[k2]*g[1]*g[2]*dc[15 + k1] + dw[k1]*g[1]*g[2]*dc[15 + k2] + dw[k2]*g[0]*g[2]*dc[18 + k1] + dw[k1]*g[0]*g[2]*dc[18 + k2] + dw[k2]*g[1]*g[2]*dc[21 + k1] + dw[k1]*g[1]*g[2]*dc[21 + k2] + dw[k2]*std::pow(g[2],2)*dc[24 + k1] + dw[k1]*std::pow(g[2],2)*dc[24 + k2] + dw[k2]*std::pow(g[0],3)*dd[k1] + dw[k1]*std::pow(g[0],3)*dd[k2] + dw[k2]*std::pow(g[0],2)*g[1]*dd[3 + k1] + dw[k1]*std::pow(g[0],2)*g[1]*dd[3 + k2] + dw[k2]*std::pow(g[0],2)*g[2]*dd[6 + k1] + dw[k1]*std::pow(g[0],2)*g[2]*dd[6 + k2] + dw[k2]*std::pow(g[0],2)*g[1]*dd[9 + k1] + dw[k1]*std::pow(g[0],2)*g[1]*dd[9 + k2] + dw[k2]*g[0]*std::pow(g[1],2)*dd[12 + k1] + dw[k1]*g[0]*std::pow(g[1],2)*dd[12 + k2] + dw[k2]*g[0]*g[1]*g[2]*dd[15 + k1] + dw[k1]*g[0]*g[1]*g[2]*dd[15 + k2] + dw[k2]*std::pow(g[0],2)*g[2]*dd[18 + k1] + dw[k1]*std::pow(g[0],2)*g[2]*dd[18 + k2] + dw[k2]*g[0]*g[1]*g[2]*dd[21 + k1] + dw[k1]*g[0]*g[1]*g[2]*dd[21 + k2] + dw[k2]*g[0]*std::pow(g[2],2)*dd[24 + k1] + dw[k1]*g[0]*std::pow(g[2],2)*dd[24 + k2] + dw[k2]*std::pow(g[0],2)*g[1]*dd[27 + k1] + dw[k1]*std::pow(g[0],2)*g[1]*dd[27 + k2] + dw[k2]*g[0]*std::pow(g[1],2)*dd[30 + k1] + dw[k1]*g[0]*std::pow(g[1],2)*dd[30 + k2] + dw[k2]*g[0]*g[1]*g[2]*dd[33 + k1] + dw[k1]*g[0]*g[1]*g[2]*dd[33 + k2] + dw[k2]*g[0]*std::pow(g[1],2)*dd[36 + k1] + dw[k1]*g[0]*std::pow(g[1],2)*dd[36 + k2] + dw[k2]*std::pow(g[1],3)*dd[39 + k1] + dw[k1]*std::pow(g[1],3)*dd[39 + k2] + dw[k2]*std::pow(g[1],2)*g[2]*dd[42 + k1] + dw[k1]*std::pow(g[1],2)*g[2]*dd[42 + k2] + dw[k2]*g[0]*g[1]*g[2]*dd[45 + k1] + dw[k1]*g[0]*g[1]*g[2]*dd[45 + k2] + dw[k2]*std::pow(g[1],2)*g[2]*dd[48 + k1] + dw[k1]*std::pow(g[1],2)*g[2]*dd[48 + k2] + dw[k2]*g[1]*std::pow(g[2],2)*dd[51 + k1] + dw[k1]*g[1]*std::pow(g[2],2)*dd[51 + k2] + dw[k2]*std::pow(g[0],2)*g[2]*dd[54 + k1] + dw[k1]*std::pow(g[0],2)*g[2]*dd[54 + k2] + dw[k2]*g[0]*g[1]*g[2]*dd[57 + k1] + dw[k1]*g[0]*g[1]*g[2]*dd[57 + k2] + dw[k2]*g[0]*std::pow(g[2],2)*dd[60 + k1] + dw[k1]*g[0]*std::pow(g[2],2)*dd[60 + k2] + dw[k2]*g[0]*g[1]*g[2]*dd[63 + k1] + dw[k1]*g[0]*g[1]*g[2]*dd[63 + k2] + dw[k2]*std::pow(g[1],2)*g[2]*dd[66 + k1] + dw[k1]*std::pow(g[1],2)*g[2]*dd[66 + k2] + dw[k2]*g[1]*std::pow(g[2],2)*dd[69 + k1] + dw[k1]*g[1]*std::pow(g[2],2)*dd[69 + k2] + dw[k2]*g[0]*std::pow(g[2],2)*dd[72 + k1] + dw[k1]*g[0]*std::pow(g[2],2)*dd[72 + k2] + dw[k2]*g[1]*std::pow(g[2],2)*dd[75 + k1] + dw[k1]*g[1]*std::pow(g[2],2)*dd[75 + k2] + dw[k2]*std::pow(g[2],3)*dd[78 + k1] + dw[k1]*std::pow(g[2],3)*dd[78 + k2] + w*g[0]*ddb[3*k1 + k2] + w*g[1]*ddb[9 + 3*k1 + k2] + w*g[2]*ddb[18 + 3*k1 + k2] + w*std::pow(g[0],2)*ddc[3*k1 + k2] + w*g[0]*g[1]*ddc[9 + 3*k1 + k2] + w*g[0]*g[2]*ddc[18 + 3*k1 + k2] + w*g[0]*g[1]*ddc[27 + 3*k1 + k2] + w*std::pow(g[1],2)*ddc[36 + 3*k1 + k2] + w*g[1]*g[2]*ddc[45 + 3*k1 + k2] + w*g[0]*g[2]*ddc[54 + 3*k1 + k2] + w*g[1]*g[2]*ddc[63 + 3*k1 + k2] + w*std::pow(g[2],2)*ddc[72 + 3*k1 + k2] + w*std::pow(g[0],3)*ddd[3*k1 + k2] + w*std::pow(g[0],2)*g[1]*ddd[9 + 3*k1 + k2] + w*std::pow(g[0],2)*g[2]*ddd[18 + 3*k1 + k2] + w*std::pow(g[0],2)*g[1]*ddd[27 + 3*k1 + k2] + w*g[0]*std::pow(g[1],2)*ddd[36 + 3*k1 + k2] + w*g[0]*g[1]*g[2]*ddd[45 + 3*k1 + k2] + w*std::pow(g[0],2)*g[2]*ddd[54 + 3*k1 + k2] + w*g[0]*g[1]*g[2]*ddd[63 + 3*k1 + k2] + w*g[0]*std::pow(g[2],2)*ddd[72 + 3*k1 + k2] + w*std::pow(g[0],2)*g[1]*ddd[81 + 3*k1 + k2] + w*g[0]*std::pow(g[1],2)*ddd[90 + 3*k1 + k2] + w*g[0]*g[1]*g[2]*ddd[99 + 3*k1 + k2] + w*g[0]*std::pow(g[1],2)*ddd[108 + 3*k1 + k2] + w*std::pow(g[1],3)*ddd[117 + 3*k1 + k2] + w*std::pow(g[1],2)*g[2]*ddd[126 + 3*k1 + k2] + w*g[0]*g[1]*g[2]*ddd[135 + 3*k1 + k2] + w*std::pow(g[1],2)*g[2]*ddd[144 + 3*k1 + k2] + w*g[1]*std::pow(g[2],2)*ddd[153 + 3*k1 + k2] + w*std::pow(g[0],2)*g[2]*ddd[162 + 3*k1 + k2] + w*g[0]*g[1]*g[2]*ddd[171 + 3*k1 + k2] + w*g[0]*std::pow(g[2],2)*ddd[180 + 3*k1 + k2] + w*g[0]*g[1]*g[2]*ddd[189 + 3*k1 + k2] + w*std::pow(g[1],2)*g[2]*ddd[198 + 3*k1 + k2] + w*g[1]*std::pow(g[2],2)*ddd[207 + 3*k1 + k2] + w*g[0]*std::pow(g[2],2)*ddd[216 + 3*k1 + k2] + w*g[1]*std::pow(g[2],2)*ddd[225 + 3*k1 + k2] + w*std::pow(g[2],3)*ddd[234 + 3*k1 + k2] + b[0]*dw[k2]*dg[k1] + 2*c[0]*dw[k2]*g[0]*dg[k1] + 3*d[0]*dw[k2]*std::pow(g[0],2)*dg[k1] + c[1]*dw[k2]*g[1]*dg[k1] + c[3]*dw[k2]*g[1]*dg[k1] + 2*d[1]*dw[k2]*g[0]*g[1]*dg[k1] + 2*d[3]*dw[k2]*g[0]*g[1]*dg[k1] + 2*d[9]*dw[k2]*g[0]*g[1]*dg[k1] + d[4]*dw[k2]*std::pow(g[1],2)*dg[k1] + d[10]*dw[k2]*std::pow(g[1],2)*dg[k1] + d[12]*dw[k2]*std::pow(g[1],2)*dg[k1] + c[2]*dw[k2]*g[2]*dg[k1] + c[6]*dw[k2]*g[2]*dg[k1] + 2*d[2]*dw[k2]*g[0]*g[2]*dg[k1] + 2*d[6]*dw[k2]*g[0]*g[2]*dg[k1] + 2*d[18]*dw[k2]*g[0]*g[2]*dg[k1] + d[5]*dw[k2]*g[1]*g[2]*dg[k1] + d[7]*dw[k2]*g[1]*g[2]*dg[k1] + d[11]*dw[k2]*g[1]*g[2]*dg[k1] + d[15]*dw[k2]*g[1]*g[2]*dg[k1] + d[19]*dw[k2]*g[1]*g[2]*dg[k1] + d[21]*dw[k2]*g[1]*g[2]*dg[k1] + d[8]*dw[k2]*std::pow(g[2],2)*dg[k1] + d[20]*dw[k2]*std::pow(g[2],2)*dg[k1] + d[24]*dw[k2]*std::pow(g[2],2)*dg[k1] + w*db[k2]*dg[k1] + 2*w*g[0]*dc[k2]*dg[k1] + w*g[1]*dc[3 + k2]*dg[k1] + w*g[2]*dc[6 + k2]*dg[k1] + w*g[1]*dc[9 + k2]*dg[k1] + w*g[2]*dc[18 + k2]*dg[k1] + 3*w*std::pow(g[0],2)*dd[k2]*dg[k1] + 2*w*g[0]*g[1]*dd[3 + k2]*dg[k1] + 2*w*g[0]*g[2]*dd[6 + k2]*dg[k1] + 2*w*g[0]*g[1]*dd[9 + k2]*dg[k1] + w*std::pow(g[1],2)*dd[12 + k2]*dg[k1] + w*g[1]*g[2]*dd[15 + k2]*dg[k1] + 2*w*g[0]*g[2]*dd[18 + k2]*dg[k1] + w*g[1]*g[2]*dd[21 + k2]*dg[k1] + w*std::pow(g[2],2)*dd[24 + k2]*dg[k1] + 2*w*g[0]*g[1]*dd[27 + k2]*dg[k1] + w*std::pow(g[1],2)*dd[30 + k2]*dg[k1] + w*g[1]*g[2]*dd[33 + k2]*dg[k1] + w*std::pow(g[1],2)*dd[36 + k2]*dg[k1] + w*g[1]*g[2]*dd[45 + k2]*dg[k1] + 2*w*g[0]*g[2]*dd[54 + k2]*dg[k1] + w*g[1]*g[2]*dd[57 + k2]*dg[k1] + w*std::pow(g[2],2)*dd[60 + k2]*dg[k1] + w*g[1]*g[2]*dd[63 + k2]*dg[k1] + w*std::pow(g[2],2)*dd[72 + k2]*dg[k1] + b[0]*dw[k1]*dg[k2] + 2*c[0]*dw[k1]*g[0]*dg[k2] + 3*d[0]*dw[k1]*std::pow(g[0],2)*dg[k2] + c[1]*dw[k1]*g[1]*dg[k2] + c[3]*dw[k1]*g[1]*dg[k2] + 2*d[1]*dw[k1]*g[0]*g[1]*dg[k2] + 2*d[3]*dw[k1]*g[0]*g[1]*dg[k2] + 2*d[9]*dw[k1]*g[0]*g[1]*dg[k2] + d[4]*dw[k1]*std::pow(g[1],2)*dg[k2] + d[10]*dw[k1]*std::pow(g[1],2)*dg[k2] + d[12]*dw[k1]*std::pow(g[1],2)*dg[k2] + c[2]*dw[k1]*g[2]*dg[k2] + c[6]*dw[k1]*g[2]*dg[k2] + 2*d[2]*dw[k1]*g[0]*g[2]*dg[k2] + 2*d[6]*dw[k1]*g[0]*g[2]*dg[k2] + 2*d[18]*dw[k1]*g[0]*g[2]*dg[k2] + d[5]*dw[k1]*g[1]*g[2]*dg[k2] + d[7]*dw[k1]*g[1]*g[2]*dg[k2] + d[11]*dw[k1]*g[1]*g[2]*dg[k2] + d[15]*dw[k1]*g[1]*g[2]*dg[k2] + d[19]*dw[k1]*g[1]*g[2]*dg[k2] + d[21]*dw[k1]*g[1]*g[2]*dg[k2] + d[8]*dw[k1]*std::pow(g[2],2)*dg[k2] + d[20]*dw[k1]*std::pow(g[2],2)*dg[k2] + d[24]*dw[k1]*std::pow(g[2],2)*dg[k2] + w*db[k1]*dg[k2] + 2*w*g[0]*dc[k1]*dg[k2] + w*g[1]*dc[3 + k1]*dg[k2] + w*g[2]*dc[6 + k1]*dg[k2] + w*g[1]*dc[9 + k1]*dg[k2] + w*g[2]*dc[18 + k1]*dg[k2] + 3*w*std::pow(g[0],2)*dd[k1]*dg[k2] + 2*w*g[0]*g[1]*dd[3 + k1]*dg[k2] + 2*w*g[0]*g[2]*dd[6 + k1]*dg[k2] + 2*w*g[0]*g[1]*dd[9 + k1]*dg[k2] + w*std::pow(g[1],2)*dd[12 + k1]*dg[k2] + w*g[1]*g[2]*dd[15 + k1]*dg[k2] + 2*w*g[0]*g[2]*dd[18 + k1]*dg[k2] + w*g[1]*g[2]*dd[21 + k1]*dg[k2] + w*std::pow(g[2],2)*dd[24 + k1]*dg[k2] + 2*w*g[0]*g[1]*dd[27 + k1]*dg[k2] + w*std::pow(g[1],2)*dd[30 + k1]*dg[k2] + w*g[1]*g[2]*dd[33 + k1]*dg[k2] + w*std::pow(g[1],2)*dd[36 + k1]*dg[k2] + w*g[1]*g[2]*dd[45 + k1]*dg[k2] + 2*w*g[0]*g[2]*dd[54 + k1]*dg[k2] + w*g[1]*g[2]*dd[57 + k1]*dg[k2] + w*std::pow(g[2],2)*dd[60 + k1]*dg[k2] + w*g[1]*g[2]*dd[63 + k1]*dg[k2] + w*std::pow(g[2],2)*dd[72 + k1]*dg[k2] + 2*w*c[0]*dg[k1]*dg[k2] + 6*w*d[0]*g[0]*dg[k1]*dg[k2] + 2*w*d[1]*g[1]*dg[k1]*dg[k2] + 2*w*d[3]*g[1]*dg[k1]*dg[k2] + 2*w*d[9]*g[1]*dg[k1]*dg[k2] + 2*w*d[2]*g[2]*dg[k1]*dg[k2] + 2*w*d[6]*g[2]*dg[k1]*dg[k2] + 2*w*d[18]*g[2]*dg[k1]*dg[k2] + b[1]*dw[k2]*dg[3 + k1] + c[1]*dw[k2]*g[0]*dg[3 + k1] + c[3]*dw[k2]*g[0]*dg[3 + k1] + d[1]*dw[k2]*std::pow(g[0],2)*dg[3 + k1] + d[3]*dw[k2]*std::pow(g[0],2)*dg[3 + k1] + d[9]*dw[k2]*std::pow(g[0],2)*dg[3 + k1] + 2*c[4]*dw[k2]*g[1]*dg[3 + k1] + 2*d[4]*dw[k2]*g[0]*g[1]*dg[3 + k1] + 2*d[10]*dw[k2]*g[0]*g[1]*dg[3 + k1] + 2*d[12]*dw[k2]*g[0]*g[1]*dg[3 + k1] + 3*d[13]*dw[k2]*std::pow(g[1],2)*dg[3 + k1] + c[5]*dw[k2]*g[2]*dg[3 + k1] + c[7]*dw[k2]*g[2]*dg[3 + k1] + d[5]*dw[k2]*g[0]*g[2]*dg[3 + k1] + d[7]*dw[k2]*g[0]*g[2]*dg[3 + k1] + d[11]*dw[k2]*g[0]*g[2]*dg[3 + k1] + d[15]*dw[k2]*g[0]*g[2]*dg[3 + k1] + d[19]*dw[k2]*g[0]*g[2]*dg[3 + k1] + d[21]*dw[k2]*g[0]*g[2]*dg[3 + k1] + 2*d[14]*dw[k2]*g[1]*g[2]*dg[3 + k1] + 2*d[16]*dw[k2]*g[1]*g[2]*dg[3 + k1] + 2*d[22]*dw[k2]*g[1]*g[2]*dg[3 + k1] + d[17]*dw[k2]*std::pow(g[2],2)*dg[3 + k1] + d[23]*dw[k2]*std::pow(g[2],2)*dg[3 + k1] + d[25]*dw[k2]*std::pow(g[2],2)*dg[3 + k1] + w*db[3 + k2]*dg[3 + k1] + w*g[0]*dc[3 + k2]*dg[3 + k1] + w*g[0]*dc[9 + k2]*dg[3 + k1] + 2*w*g[1]*dc[12 + k2]*dg[3 + k1] + w*g[2]*dc[15 + k2]*dg[3 + k1] + w*g[2]*dc[21 + k2]*dg[3 + k1] + w*std::pow(g[0],2)*dd[3 + k2]*dg[3 + k1] + w*std::pow(g[0],2)*dd[9 + k2]*dg[3 + k1] + 2*w*g[0]*g[1]*dd[12 + k2]*dg[3 + k1] + w*g[0]*g[2]*dd[15 + k2]*dg[3 + k1] + w*g[0]*g[2]*dd[21 + k2]*dg[3 + k1] + w*std::pow(g[0],2)*dd[27 + k2]*dg[3 + k1] + 2*w*g[0]*g[1]*dd[30 + k2]*dg[3 + k1] + w*g[0]*g[2]*dd[33 + k2]*dg[3 + k1] + 2*w*g[0]*g[1]*dd[36 + k2]*dg[3 + k1] + 3*w*std::pow(g[1],2)*dd[39 + k2]*dg[3 + k1] + 2*w*g[1]*g[2]*dd[42 + k2]*dg[3 + k1] + w*g[0]*g[2]*dd[45 + k2]*dg[3 + k1] + 2*w*g[1]*g[2]*dd[48 + k2]*dg[3 + k1] + w*std::pow(g[2],2)*dd[51 + k2]*dg[3 + k1] + w*g[0]*g[2]*dd[57 + k2]*dg[3 + k1] + w*g[0]*g[2]*dd[63 + k2]*dg[3 + k1] + 2*w*g[1]*g[2]*dd[66 + k2]*dg[3 + k1] + w*std::pow(g[2],2)*dd[69 + k2]*dg[3 + k1] + w*std::pow(g[2],2)*dd[75 + k2]*dg[3 + k1] + w*c[1]*dg[k2]*dg[3 + k1] + w*c[3]*dg[k2]*dg[3 + k1] + 2*w*d[1]*g[0]*dg[k2]*dg[3 + k1] + 2*w*d[3]*g[0]*dg[k2]*dg[3 + k1] + 2*w*d[9]*g[0]*dg[k2]*dg[3 + k1] + 2*w*d[4]*g[1]*dg[k2]*dg[3 + k1] + 2*w*d[10]*g[1]*dg[k2]*dg[3 + k1] + 2*w*d[12]*g[1]*dg[k2]*dg[3 + k1] + w*d[5]*g[2]*dg[k2]*dg[3 + k1] + w*d[7]*g[2]*dg[k2]*dg[3 + k1] + w*d[11]*g[2]*dg[k2]*dg[3 + k1] + w*d[15]*g[2]*dg[k2]*dg[3 + k1] + w*d[19]*g[2]*dg[k2]*dg[3 + k1] + w*d[21]*g[2]*dg[k2]*dg[3 + k1] + b[1]*dw[k1]*dg[3 + k2] + c[1]*dw[k1]*g[0]*dg[3 + k2] + c[3]*dw[k1]*g[0]*dg[3 + k2] + d[1]*dw[k1]*std::pow(g[0],2)*dg[3 + k2] + d[3]*dw[k1]*std::pow(g[0],2)*dg[3 + k2] + d[9]*dw[k1]*std::pow(g[0],2)*dg[3 + k2] + 2*c[4]*dw[k1]*g[1]*dg[3 + k2] + 2*d[4]*dw[k1]*g[0]*g[1]*dg[3 + k2] + 2*d[10]*dw[k1]*g[0]*g[1]*dg[3 + k2] + 2*d[12]*dw[k1]*g[0]*g[1]*dg[3 + k2] + 3*d[13]*dw[k1]*std::pow(g[1],2)*dg[3 + k2] + c[5]*dw[k1]*g[2]*dg[3 + k2] + c[7]*dw[k1]*g[2]*dg[3 + k2] + d[5]*dw[k1]*g[0]*g[2]*dg[3 + k2] + d[7]*dw[k1]*g[0]*g[2]*dg[3 + k2] + d[11]*dw[k1]*g[0]*g[2]*dg[3 + k2] + d[15]*dw[k1]*g[0]*g[2]*dg[3 + k2] + d[19]*dw[k1]*g[0]*g[2]*dg[3 + k2] + d[21]*dw[k1]*g[0]*g[2]*dg[3 + k2] + 2*d[14]*dw[k1]*g[1]*g[2]*dg[3 + k2] + 2*d[16]*dw[k1]*g[1]*g[2]*dg[3 + k2] + 2*d[22]*dw[k1]*g[1]*g[2]*dg[3 + k2] + d[17]*dw[k1]*std::pow(g[2],2)*dg[3 + k2] + d[23]*dw[k1]*std::pow(g[2],2)*dg[3 + k2] + d[25]*dw[k1]*std::pow(g[2],2)*dg[3 + k2] + w*db[3 + k1]*dg[3 + k2] + w*g[0]*dc[3 + k1]*dg[3 + k2] + w*g[0]*dc[9 + k1]*dg[3 + k2] + 2*w*g[1]*dc[12 + k1]*dg[3 + k2] + w*g[2]*dc[15 + k1]*dg[3 + k2] + w*g[2]*dc[21 + k1]*dg[3 + k2] + w*std::pow(g[0],2)*dd[3 + k1]*dg[3 + k2] + w*std::pow(g[0],2)*dd[9 + k1]*dg[3 + k2] + 2*w*g[0]*g[1]*dd[12 + k1]*dg[3 + k2] + w*g[0]*g[2]*dd[15 + k1]*dg[3 + k2] + w*g[0]*g[2]*dd[21 + k1]*dg[3 + k2] + w*std::pow(g[0],2)*dd[27 + k1]*dg[3 + k2] + 2*w*g[0]*g[1]*dd[30 + k1]*dg[3 + k2] + w*g[0]*g[2]*dd[33 + k1]*dg[3 + k2] + 2*w*g[0]*g[1]*dd[36 + k1]*dg[3 + k2] + 3*w*std::pow(g[1],2)*dd[39 + k1]*dg[3 + k2] + 2*w*g[1]*g[2]*dd[42 + k1]*dg[3 + k2] + w*g[0]*g[2]*dd[45 + k1]*dg[3 + k2] + 2*w*g[1]*g[2]*dd[48 + k1]*dg[3 + k2] + w*std::pow(g[2],2)*dd[51 + k1]*dg[3 + k2] + w*g[0]*g[2]*dd[57 + k1]*dg[3 + k2] + w*g[0]*g[2]*dd[63 + k1]*dg[3 + k2] + 2*w*g[1]*g[2]*dd[66 + k1]*dg[3 + k2] + w*std::pow(g[2],2)*dd[69 + k1]*dg[3 + k2] + w*std::pow(g[2],2)*dd[75 + k1]*dg[3 + k2] + w*c[1]*dg[k1]*dg[3 + k2] + w*c[3]*dg[k1]*dg[3 + k2] + 2*w*d[1]*g[0]*dg[k1]*dg[3 + k2] + 2*w*d[3]*g[0]*dg[k1]*dg[3 + k2] + 2*w*d[9]*g[0]*dg[k1]*dg[3 + k2] + 2*w*d[4]*g[1]*dg[k1]*dg[3 + k2] + 2*w*d[10]*g[1]*dg[k1]*dg[3 + k2] + 2*w*d[12]*g[1]*dg[k1]*dg[3 + k2] + w*d[5]*g[2]*dg[k1]*dg[3 + k2] + w*d[7]*g[2]*dg[k1]*dg[3 + k2] + w*d[11]*g[2]*dg[k1]*dg[3 + k2] + w*d[15]*g[2]*dg[k1]*dg[3 + k2] + w*d[19]*g[2]*dg[k1]*dg[3 + k2] + w*d[21]*g[2]*dg[k1]*dg[3 + k2] + 2*w*c[4]*dg[3 + k1]*dg[3 + k2] + 2*w*d[4]*g[0]*dg[3 + k1]*dg[3 + k2] + 2*w*d[10]*g[0]*dg[3 + k1]*dg[3 + k2] + 2*w*d[12]*g[0]*dg[3 + k1]*dg[3 + k2] + 6*w*d[13]*g[1]*dg[3 + k1]*dg[3 + k2] + 2*w*d[14]*g[2]*dg[3 + k1]*dg[3 + k2] + 2*w*d[16]*g[2]*dg[3 + k1]*dg[3 + k2] + 2*w*d[22]*g[2]*dg[3 + k1]*dg[3 + k2] + b[2]*dw[k2]*dg[6 + k1] + c[2]*dw[k2]*g[0]*dg[6 + k1] + c[6]*dw[k2]*g[0]*dg[6 + k1] + d[2]*dw[k2]*std::pow(g[0],2)*dg[6 + k1] + d[6]*dw[k2]*std::pow(g[0],2)*dg[6 + k1] + d[18]*dw[k2]*std::pow(g[0],2)*dg[6 + k1] + c[5]*dw[k2]*g[1]*dg[6 + k1] + c[7]*dw[k2]*g[1]*dg[6 + k1] + d[5]*dw[k2]*g[0]*g[1]*dg[6 + k1] + d[7]*dw[k2]*g[0]*g[1]*dg[6 + k1] + d[11]*dw[k2]*g[0]*g[1]*dg[6 + k1] + d[15]*dw[k2]*g[0]*g[1]*dg[6 + k1] + d[19]*dw[k2]*g[0]*g[1]*dg[6 + k1] + d[21]*dw[k2]*g[0]*g[1]*dg[6 + k1] + d[14]*dw[k2]*std::pow(g[1],2)*dg[6 + k1] + d[16]*dw[k2]*std::pow(g[1],2)*dg[6 + k1] + d[22]*dw[k2]*std::pow(g[1],2)*dg[6 + k1] + 2*c[8]*dw[k2]*g[2]*dg[6 + k1] + 2*d[8]*dw[k2]*g[0]*g[2]*dg[6 + k1] + 2*d[20]*dw[k2]*g[0]*g[2]*dg[6 + k1] + 2*d[24]*dw[k2]*g[0]*g[2]*dg[6 + k1] + 2*d[17]*dw[k2]*g[1]*g[2]*dg[6 + k1] + 2*d[23]*dw[k2]*g[1]*g[2]*dg[6 + k1] + 2*d[25]*dw[k2]*g[1]*g[2]*dg[6 + k1] + 3*d[26]*dw[k2]*std::pow(g[2],2)*dg[6 + k1] + w*db[6 + k2]*dg[6 + k1] + w*g[0]*dc[6 + k2]*dg[6 + k1] + w*g[1]*dc[15 + k2]*dg[6 + k1] + w*g[0]*dc[18 + k2]*dg[6 + k1] + w*g[1]*dc[21 + k2]*dg[6 + k1] + 2*w*g[2]*dc[24 + k2]*dg[6 + k1] + w*std::pow(g[0],2)*dd[6 + k2]*dg[6 + k1] + w*g[0]*g[1]*dd[15 + k2]*dg[6 + k1] + w*std::pow(g[0],2)*dd[18 + k2]*dg[6 + k1] + w*g[0]*g[1]*dd[21 + k2]*dg[6 + k1] + 2*w*g[0]*g[2]*dd[24 + k2]*dg[6 + k1] + w*g[0]*g[1]*dd[33 + k2]*dg[6 + k1] + w*std::pow(g[1],2)*dd[42 + k2]*dg[6 + k1] + w*g[0]*g[1]*dd[45 + k2]*dg[6 + k1] + w*std::pow(g[1],2)*dd[48 + k2]*dg[6 + k1] + 2*w*g[1]*g[2]*dd[51 + k2]*dg[6 + k1] + w*std::pow(g[0],2)*dd[54 + k2]*dg[6 + k1] + w*g[0]*g[1]*dd[57 + k2]*dg[6 + k1] + 2*w*g[0]*g[2]*dd[60 + k2]*dg[6 + k1] + w*g[0]*g[1]*dd[63 + k2]*dg[6 + k1] + w*std::pow(g[1],2)*dd[66 + k2]*dg[6 + k1] + 2*w*g[1]*g[2]*dd[69 + k2]*dg[6 + k1] + 2*w*g[0]*g[2]*dd[72 + k2]*dg[6 + k1] + 2*w*g[1]*g[2]*dd[75 + k2]*dg[6 + k1] + 3*w*std::pow(g[2],2)*dd[78 + k2]*dg[6 + k1] + w*c[2]*dg[k2]*dg[6 + k1] + w*c[6]*dg[k2]*dg[6 + k1] + 2*w*d[2]*g[0]*dg[k2]*dg[6 + k1] + 2*w*d[6]*g[0]*dg[k2]*dg[6 + k1] + 2*w*d[18]*g[0]*dg[k2]*dg[6 + k1] + w*d[5]*g[1]*dg[k2]*dg[6 + k1] + w*d[7]*g[1]*dg[k2]*dg[6 + k1] + w*d[11]*g[1]*dg[k2]*dg[6 + k1] + w*d[15]*g[1]*dg[k2]*dg[6 + k1] + w*d[19]*g[1]*dg[k2]*dg[6 + k1] + w*d[21]*g[1]*dg[k2]*dg[6 + k1] + 2*w*d[8]*g[2]*dg[k2]*dg[6 + k1] + 2*w*d[20]*g[2]*dg[k2]*dg[6 + k1] + 2*w*d[24]*g[2]*dg[k2]*dg[6 + k1] + w*c[5]*dg[3 + k2]*dg[6 + k1] + w*c[7]*dg[3 + k2]*dg[6 + k1] + w*d[5]*g[0]*dg[3 + k2]*dg[6 + k1] + w*d[7]*g[0]*dg[3 + k2]*dg[6 + k1] + w*d[11]*g[0]*dg[3 + k2]*dg[6 + k1] + w*d[15]*g[0]*dg[3 + k2]*dg[6 + k1] + w*d[19]*g[0]*dg[3 + k2]*dg[6 + k1] + w*d[21]*g[0]*dg[3 + k2]*dg[6 + k1] + 2*w*d[14]*g[1]*dg[3 + k2]*dg[6 + k1] + 2*w*d[16]*g[1]*dg[3 + k2]*dg[6 + k1] + 2*w*d[22]*g[1]*dg[3 + k2]*dg[6 + k1] + 2*w*d[17]*g[2]*dg[3 + k2]*dg[6 + k1] + 2*w*d[23]*g[2]*dg[3 + k2]*dg[6 + k1] + 2*w*d[25]*g[2]*dg[3 + k2]*dg[6 + k1] + b[2]*dw[k1]*dg[6 + k2] + c[2]*dw[k1]*g[0]*dg[6 + k2] + c[6]*dw[k1]*g[0]*dg[6 + k2] + d[2]*dw[k1]*std::pow(g[0],2)*dg[6 + k2] + d[6]*dw[k1]*std::pow(g[0],2)*dg[6 + k2] + d[18]*dw[k1]*std::pow(g[0],2)*dg[6 + k2] + c[5]*dw[k1]*g[1]*dg[6 + k2] + c[7]*dw[k1]*g[1]*dg[6 + k2] + d[5]*dw[k1]*g[0]*g[1]*dg[6 + k2] + d[7]*dw[k1]*g[0]*g[1]*dg[6 + k2] + d[11]*dw[k1]*g[0]*g[1]*dg[6 + k2] + d[15]*dw[k1]*g[0]*g[1]*dg[6 + k2] + d[19]*dw[k1]*g[0]*g[1]*dg[6 + k2] + d[21]*dw[k1]*g[0]*g[1]*dg[6 + k2] + d[14]*dw[k1]*std::pow(g[1],2)*dg[6 + k2] + d[16]*dw[k1]*std::pow(g[1],2)*dg[6 + k2] + d[22]*dw[k1]*std::pow(g[1],2)*dg[6 + k2] + 2*c[8]*dw[k1]*g[2]*dg[6 + k2] + 2*d[8]*dw[k1]*g[0]*g[2]*dg[6 + k2] + 2*d[20]*dw[k1]*g[0]*g[2]*dg[6 + k2] + 2*d[24]*dw[k1]*g[0]*g[2]*dg[6 + k2] + 2*d[17]*dw[k1]*g[1]*g[2]*dg[6 + k2] + 2*d[23]*dw[k1]*g[1]*g[2]*dg[6 + k2] + 2*d[25]*dw[k1]*g[1]*g[2]*dg[6 + k2] + 3*d[26]*dw[k1]*std::pow(g[2],2)*dg[6 + k2] + w*db[6 + k1]*dg[6 + k2] + w*g[0]*dc[6 + k1]*dg[6 + k2] + w*g[1]*dc[15 + k1]*dg[6 + k2] + w*g[0]*dc[18 + k1]*dg[6 + k2] + w*g[1]*dc[21 + k1]*dg[6 + k2] + 2*w*g[2]*dc[24 + k1]*dg[6 + k2] + w*std::pow(g[0],2)*dd[6 + k1]*dg[6 + k2] + w*g[0]*g[1]*dd[15 + k1]*dg[6 + k2] + w*std::pow(g[0],2)*dd[18 + k1]*dg[6 + k2] + w*g[0]*g[1]*dd[21 + k1]*dg[6 + k2] + 2*w*g[0]*g[2]*dd[24 + k1]*dg[6 + k2] + w*g[0]*g[1]*dd[33 + k1]*dg[6 + k2] + w*std::pow(g[1],2)*dd[42 + k1]*dg[6 + k2] + w*g[0]*g[1]*dd[45 + k1]*dg[6 + k2] + w*std::pow(g[1],2)*dd[48 + k1]*dg[6 + k2] + 2*w*g[1]*g[2]*dd[51 + k1]*dg[6 + k2] + w*std::pow(g[0],2)*dd[54 + k1]*dg[6 + k2] + w*g[0]*g[1]*dd[57 + k1]*dg[6 + k2] + 2*w*g[0]*g[2]*dd[60 + k1]*dg[6 + k2] + w*g[0]*g[1]*dd[63 + k1]*dg[6 + k2] + w*std::pow(g[1],2)*dd[66 + k1]*dg[6 + k2] + 2*w*g[1]*g[2]*dd[69 + k1]*dg[6 + k2] + 2*w*g[0]*g[2]*dd[72 + k1]*dg[6 + k2] + 2*w*g[1]*g[2]*dd[75 + k1]*dg[6 + k2] + 3*w*std::pow(g[2],2)*dd[78 + k1]*dg[6 + k2] + w*c[2]*dg[k1]*dg[6 + k2] + w*c[6]*dg[k1]*dg[6 + k2] + 2*w*d[2]*g[0]*dg[k1]*dg[6 + k2] + 2*w*d[6]*g[0]*dg[k1]*dg[6 + k2] + 2*w*d[18]*g[0]*dg[k1]*dg[6 + k2] + w*d[5]*g[1]*dg[k1]*dg[6 + k2] + w*d[7]*g[1]*dg[k1]*dg[6 + k2] + w*d[11]*g[1]*dg[k1]*dg[6 + k2] + w*d[15]*g[1]*dg[k1]*dg[6 + k2] + w*d[19]*g[1]*dg[k1]*dg[6 + k2] + w*d[21]*g[1]*dg[k1]*dg[6 + k2] + 2*w*d[8]*g[2]*dg[k1]*dg[6 + k2] + 2*w*d[20]*g[2]*dg[k1]*dg[6 + k2] + 2*w*d[24]*g[2]*dg[k1]*dg[6 + k2] + w*c[5]*dg[3 + k1]*dg[6 + k2] + w*c[7]*dg[3 + k1]*dg[6 + k2] + w*d[5]*g[0]*dg[3 + k1]*dg[6 + k2] + w*d[7]*g[0]*dg[3 + k1]*dg[6 + k2] + w*d[11]*g[0]*dg[3 + k1]*dg[6 + k2] + w*d[15]*g[0]*dg[3 + k1]*dg[6 + k2] + w*d[19]*g[0]*dg[3 + k1]*dg[6 + k2] + w*d[21]*g[0]*dg[3 + k1]*dg[6 + k2] + 2*w*d[14]*g[1]*dg[3 + k1]*dg[6 + k2] + 2*w*d[16]*g[1]*dg[3 + k1]*dg[6 + k2] + 2*w*d[22]*g[1]*dg[3 + k1]*dg[6 + k2] + 2*w*d[17]*g[2]*dg[3 + k1]*dg[6 + k2] + 2*w*d[23]*g[2]*dg[3 + k1]*dg[6 + k2] + 2*w*d[25]*g[2]*dg[3 + k1]*dg[6 + k2] + 2*w*c[8]*dg[6 + k1]*dg[6 + k2] + 2*w*d[8]*g[0]*dg[6 + k1]*dg[6 + k2] + 2*w*d[20]*g[0]*dg[6 + k1]*dg[6 + k2] + 2*w*d[24]*g[0]*dg[6 + k1]*dg[6 + k2] + 2*w*d[17]*g[1]*dg[6 + k1]*dg[6 + k2] + 2*w*d[23]*g[1]*dg[6 + k1]*dg[6 + k2] + 2*w*d[25]*g[1]*dg[6 + k1]*dg[6 + k2] + 6*w*d[26]*g[2]*dg[6 + k1]*dg[6 + k2];
      }
    }
    break;
  }
