...
void solveC(const Dim<3>::FourthRankTensor& L,
            ...
            Dim<3>::Tensor& C) {
  typedef Eigen::Matrix<double, 9, 9, Eigen::RowMajor> MatrixType;
  typedef Eigen::Matrix<double, 9, 1> VectorType;
  MatrixType A;
  VectorType b;
  A << L(0,0,0,0), L(1,0,0,0), L(2,0,0,0), L(0,1,0,0), L(1,1,0,0), L(2,1,0,0), L(0,2,0,0), L(1,2,0,0), L(2,2,0,0), 
       L(0,0,1,0), L(1,0,1,0), L(2,0,1,0), L(0,1,1,0), L(1,1,1,0), L(2,1,1,0), L(0,2,1,0), L(1,2,1,0), L(2,2,1,0), 
       L(0,0,2,0), L(1,0,2,0), L(2,0,2,0), L(0,1,2,0), L(1,1,2,0), L(2,1,2,0), L(0,2,2,0), L(1,2,2,0), L(2,2,2,0), 
       L(0,0,0,1), L(1,0,0,1), L(2,0,0,1), L(0,1,0,1), L(1,1,0,1), L(2,1,0,1), L(0,2,0,1), L(1,2,0,1), L(2,2,0,1), 
       L(0,0,1,1), L(1,0,1,1), L(2,0,1,1), L(0,1,1,1), L(1,1,1,1), L(2,1,1,1), L(0,2,1,1), L(1,2,1,1), L(2,2,1,1), 
       L(0,0,2,1), L(1,0,2,1), L(2,0,2,1), L(0,1,2,1), L(1,1,2,1), L(2,1,2,1), L(0,2,2,1), L(1,2,2,1), L(2,2,2,1), 
       L(0,0,0,2), L(1,0,0,2), L(2,0,0,2), L(0,1,0,2), L(1,1,0,2), L(2,1,0,2), L(0,2,0,2), L(1,2,0,2), L(2,2,0,2), 
       L(0,0,1,2), L(1,0,1,2), L(2,0,1,2), L(0,1,1,2), L(1,1,1,2), L(2,1,1,2), L(0,2,1,2), L(1,2,1,2), L(2,2,1,2), 
       L(0,0,2,2), L(1,0,2,2), L(2,0,2,2), L(0,1,2,2), L(1,1,2,2), L(2,1,2,2), L(0,2,2,2), L(1,2,2,2), L(2,2,2,2);
  b << Q(0,0), Q(1,0), Q(2,0), Q(0,1), Q(1,1), Q(2,1), Q(0,2), Q(1,2), Q(2,2);
  VectorType x = A.colPivHouseholderQr().solve(b);
  C(0,0) = x(0);
  C(0,1) = x(1);
  C(0,2) = x(2);
