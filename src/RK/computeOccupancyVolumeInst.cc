...
template void computeOccupancyVolume(const ConnectivityMap<Dim<1> >&,
...
template void computeOccupancyVolume(const ConnectivityMap<Dim<2> >&,
...
template void computeOccupancyVolume(const ConnectivityMap<Dim<3> >&,
