...
template void computeRKSumVolume(const ConnectivityMap<Dim<1> >&,
...
template void computeRKSumVolume(const ConnectivityMap<Dim<2> >&,
...
template void computeRKSumVolume(const ConnectivityMap<Dim<3> >&,
