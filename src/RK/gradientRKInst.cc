...
gradientRK<Dim<1>, Dim<1>::Scalar>(const FieldList<Dim<1>, Dim<1>::Scalar>& fieldList,
...
gradientRK<Dim<1>, Dim<1>::Scalar>(const FieldList<Dim<1>, std::vector<Dim<1>::Scalar>>& fieldList,
                                                      const FieldList<Dim<1>, Dim<1>::Vector>& position,
                                                      const FieldList<Dim<1>, Dim<1>::Scalar>& weight,
                                                      const FieldList<Dim<1>, Dim<1>::SymTensor>& H,
                                                      const ConnectivityMap<Dim<1>>& connectivityMap,
...
gradientRK<Dim<1>, Dim<1>::Vector>(const FieldList<Dim<1>, Dim<1>::Vector>& fieldList,
                                                      const FieldList<Dim<1>, Dim<1>::Vector>& position,
                                                      const FieldList<Dim<1>, Dim<1>::Scalar>& weight,
                                                      const FieldList<Dim<1>, Dim<1>::SymTensor>& H,
                                                      const ConnectivityMap<Dim<1>>& connectivityMap,
...
gradientRK<Dim<1>, Dim<1>::Vector>(const FieldList<Dim<1>, std::vector<Dim<1>::Vector>>& fieldList,
                                                      const FieldList<Dim<1>, Dim<1>::Vector>& position,
                                                      const FieldList<Dim<1>, Dim<1>::Scalar>& weight,
                                                      const FieldList<Dim<1>, Dim<1>::SymTensor>& H,
                                                      const ConnectivityMap<Dim<1>>& connectivityMap,
...
gradientRK<Dim<2>, Dim<2>::Scalar>(const FieldList<Dim<2>, Dim<2>::Scalar>& fieldList,
...
gradientRK<Dim<2>, Dim<2>::Scalar>(const FieldList<Dim<2>, std::vector<Dim<2>::Scalar>>& fieldList,
                                                      const FieldList<Dim<2>, Dim<2>::Vector>& position,
                                                      const FieldList<Dim<2>, Dim<2>::Scalar>& weight,
                                                      const FieldList<Dim<2>, Dim<2>::SymTensor>& H,
                                                      const ConnectivityMap<Dim<2>>& connectivityMap,
...
gradientRK<Dim<2>, Dim<2>::Vector>(const FieldList<Dim<2>, Dim<2>::Vector>& fieldList,
                                                      const FieldList<Dim<2>, Dim<2>::Vector>& position,
                                                      const FieldList<Dim<2>, Dim<2>::Scalar>& weight,
                                                      const FieldList<Dim<2>, Dim<2>::SymTensor>& H,
                                                      const ConnectivityMap<Dim<2>>& connectivityMap,
...
gradientRK<Dim<2>, Dim<2>::Vector>(const FieldList<Dim<2>, std::vector<Dim<2>::Vector>>& fieldList,
                                                      const FieldList<Dim<2>, Dim<2>::Vector>& position,
                                                      const FieldList<Dim<2>, Dim<2>::Scalar>& weight,
                                                      const FieldList<Dim<2>, Dim<2>::SymTensor>& H,
                                                      const ConnectivityMap<Dim<2>>& connectivityMap,
...
gradientRK<Dim<3>, Dim<3>::Scalar>(const FieldList<Dim<3>, Dim<3>::Scalar>& fieldList,
...
gradientRK<Dim<3>, Dim<3>::Scalar>(const FieldList<Dim<3>, std::vector<Dim<3>::Scalar>>& fieldList,
                                                      const FieldList<Dim<3>, Dim<3>::Vector>& position,
                                                      const FieldList<Dim<3>, Dim<3>::Scalar>& weight,
                                                      const FieldList<Dim<3>, Dim<3>::SymTensor>& H,
                                                      const ConnectivityMap<Dim<3>>& connectivityMap,
...
gradientRK<Dim<3>, Dim<3>::Vector>(const FieldList<Dim<3>, Dim<3>::Vector>& fieldList,
                                                      const FieldList<Dim<3>, Dim<3>::Vector>& position,
                                                      const FieldList<Dim<3>, Dim<3>::Scalar>& weight,
                                                      const FieldList<Dim<3>, Dim<3>::SymTensor>& H,
                                                      const ConnectivityMap<Dim<3>>& connectivityMap,
...
gradientRK<Dim<3>, Dim<3>::Vector>(const FieldList<Dim<3>, std::vector<Dim<3>::Vector>>& fieldList,
                                                      const FieldList<Dim<3>, Dim<3>::Vector>& position,
                                                      const FieldList<Dim<3>, Dim<3>::Scalar>& weight,
                                                      const FieldList<Dim<3>, Dim<3>::SymTensor>& H,
                                                      const ConnectivityMap<Dim<3>>& connectivityMap,
