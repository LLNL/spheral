...
for Value in ("Scalar", "Vector"):
    text += """
template
FieldList<Dim<%1>, MathTraits<Dim<%1>, Dim<%1>::%(Value)s>::HessianType>
hessianRK<Dim<%1>, Dim<%1>::%(Value)s>(const FieldList<Dim<%1>, Dim<%1>::%(Value)s>& fieldList,
...
for Value in ("Scalar", "Vector"):
    text += """
template
FieldList<Dim<%2>, MathTraits<Dim<%2>, Dim<%2>::%(Value)s>::HessianType>
hessianRK<Dim<%2>, Dim<%2>::%(Value)s>(const FieldList<Dim<%2>, Dim<%2>::%(Value)s>& fieldList,
...
for Value in ("Scalar", "Vector"):
    text += """
template
FieldList<Dim<%3>, MathTraits<Dim<%3>, Dim<%3>::%(Value)s>::HessianType>
hessianRK<Dim<%3>, Dim<%3>::%(Value)s>(const FieldList<Dim<%3>, Dim<%3>::%(Value)s>& fieldList,
