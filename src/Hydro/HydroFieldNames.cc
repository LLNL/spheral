...
const std::string Spheral::HydroFieldNames::A_RK = "A RK correction";
const std::string Spheral::HydroFieldNames::B_RK = "B RK correction";
const std::string Spheral::HydroFieldNames::C_RK = "C RK correction";
const std::string Spheral::HydroFieldNames::D_RK = "D RK correction";
const std::string Spheral::HydroFieldNames::gradA_RK = "A RK correction gradient";
const std::string Spheral::HydroFieldNames::gradB_RK = "B RK correction gradient";
const std::string Spheral::HydroFieldNames::gradC_RK = "C RK correction gradient";
const std::string Spheral::HydroFieldNames::gradD_RK = "D RK correction gradient";
const std::string Spheral::HydroFieldNames::hessA_RK = "A RK correction hessian";
