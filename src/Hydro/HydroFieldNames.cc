...
const std::string Spheral::HydroFieldNames::massSecondMomentEta = "mass second moment eta frame";
const std::string Spheral::HydroFieldNames::massSecondMomentLab = "mass second moment lab frame";
