...
const std::string Spheral::HydroFieldNames::ahgAcceleration = "delta " + Spheral::HydroFieldNames::velocity + " anti hourglass";       // Note here we *must* start with "delta " to work with IncrementFieldList!
