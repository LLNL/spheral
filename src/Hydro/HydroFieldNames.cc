...
const std::string Spheral::HydroFieldNames::A0_CSPH = "A0 CSPH correction";
const std::string Spheral::HydroFieldNames::A_CSPH = "A CSPH correction";
...
const std::string Spheral::HydroFieldNames::reducingViscosityMultiplier = "the Morris & Monaghan reducing viscosity parameter";
