...
updateTimer.start()
nodes1.updateWeight(db.connectivityMap())
updateTimer.stop()
...
################################################################################
# Test the gravity packages derivative
title('2-D Gravity test')

gravity = GadgetGravity2d()
output('gravity')
output('gravity.valid')
...
derivTimer.start()
gravity.evaluateDerivatives(db, 0.0, 0.01, DvDt)
derivTimer.stop()
