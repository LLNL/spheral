...
#include "computeCSPHCorrections2.cc"

namespace Spheral {
  namespace CSPHSpace {
    template void computeCSPHCorrections2(const ConnectivityMap<Dim<1> >&, 
    ...
    template void computeCSPHCorrections2(const ConnectivityMap<Dim<2> >&, 
    ...
    template void computeCSPHCorrections2(const ConnectivityMap<Dim<3> >&, 
