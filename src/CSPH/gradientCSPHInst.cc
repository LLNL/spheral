...
namespace Spheral {
  namespace CSPHSpace {
    ...
    gradientCSPH<Dim<1>, Dim<1>::Scalar>(const FieldList<Dim<1>, Dim<1>::Scalar>& fieldList,
    ...
    gradientCSPH<Dim<1>, Dim<1>::Vector>(const FieldList<Dim<1>, Dim<1>::Vector>& fieldList,
					 const FieldList<Dim<1>, Dim<1>::Vector>& position,
					 const FieldList<Dim<1>, Dim<1>::Scalar>& weight,
					 const FieldList<Dim<1>, Dim<1>::SymTensor>& Hfield,
					 const FieldList<Dim<1>, Dim<1>::Scalar>& A,
    ...
    gradientCSPH<Dim<2>, Dim<2>::Scalar>(const FieldList<Dim<2>, Dim<2>::Scalar>& fieldList,
    ...
    gradientCSPH<Dim<2>, Dim<2>::Vector>(const FieldList<Dim<2>, Dim<2>::Vector>& fieldList,
					 const FieldList<Dim<2>, Dim<2>::Vector>& position,
					 const FieldList<Dim<2>, Dim<2>::Scalar>& weight,
					 const FieldList<Dim<2>, Dim<2>::SymTensor>& Hfield,
					 const FieldList<Dim<2>, Dim<2>::Scalar>& A,
    ...
    gradientCSPH<Dim<3>, Dim<3>::Scalar>(const FieldList<Dim<3>, Dim<3>::Scalar>& fieldList,
    ...
    gradientCSPH<Dim<3>, Dim<3>::Vector>(const FieldList<Dim<3>, Dim<3>::Vector>& fieldList,
					 const FieldList<Dim<3>, Dim<3>::Vector>& position,
					 const FieldList<Dim<3>, Dim<3>::Scalar>& weight,
					 const FieldList<Dim<3>, Dim<3>::SymTensor>& Hfield,
					 const FieldList<Dim<3>, Dim<3>::Scalar>& A,
