...
#include "computeCSPHIntegral.cc"

namespace Spheral {
  namespace CSPHSpace {
    template std::pair<Dim<1>::Vector,Dim<1>::Vector> computeCSPHIntegral(const ConnectivityMap<Dim<1> >&, 
    ...
    template std::pair<Dim<2>::Vector,Dim<2>::Vector> computeCSPHIntegral(const ConnectivityMap<Dim<2> >&, 
    ...
    template std::pair<Dim<3>::Vector,Dim<3>::Vector> computeCSPHIntegral(const ConnectivityMap<Dim<3> >&, 
