...
#include "computeCSPHEvaluation.cc"

namespace Spheral {
  namespace CSPHSpace {
    template void computeCSPHEvaluation(const ConnectivityMap<Dim<1> >&, 
    ...
    template void computeCSPHEvaluation(const ConnectivityMap<Dim<2> >&, 
    ...
    template void computeCSPHEvaluation(const ConnectivityMap<Dim<3> >&, 
