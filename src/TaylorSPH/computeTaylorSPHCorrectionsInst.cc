...
namespace Spheral {
  namespace TaylorSPHSpace {
    template void computeTaylorSPHCorrections(const ConnectivityMap<Dim<1> >&, 
    ...
    template void computeTaylorSPHCorrections(const ConnectivityMap<Dim<2> >&, 
    ...
    template void computeTaylorSPHCorrections(const ConnectivityMap<Dim<3> >&, 
