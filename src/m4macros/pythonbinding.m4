...
[
    ...
    PYTHONPKGS="Geometry CXXTypes Silo DataOutput NodeList Field Kernel Neighbor Material FileIO DataBase Boundary Physics ArtificialViscosity Hydro ExternalForce Gravity Integrator Utilities NodeGenerators FieldOperations SPH CRKSPH SVPH TaylorSPH Mesh Damage SolidMaterial Strength ArtificialConduction $PYTHONPKGS"
    PYOPT="$PYOPT"
