...
[
    ...
    PYTHONPKGS+=" CXXTypes Geometry PolyClipper Silo DataOutput NodeList Field Kernel Neighbor Material FileIO DataBase Boundary Physics Hydro ExternalForce Gravity Integrator Utilities NodeGenerators FieldOperations SPH CRKSPH ArtificialViscosity SVPH Mesh Damage SolidMaterial Strength ArtificialConduction $PYTHONPKS"
