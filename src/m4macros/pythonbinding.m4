...
[
    ...
    PYTHONPKGS+=" CXXTypes Geometry PolyClipper Silo DataOutput NodeList Field Kernel Neighbor Material FileIO Utilities DataBase Boundary Physics Hydro ExternalForce Gravity Integrator NodeGenerators FieldOperations SPH CRKSPH ArtificialViscosity SVPH Mesh Damage SolidMaterial Strength ArtificialConduction"
