...
[
   ...
   AC_MSG_RESULT(no)
   CXXPKGS="Geometry NodeList Field FieldOperations Kernel Material Neighbor DataBase Boundary Physics ArtificialViscosity Hydro ExternalForce Gravity Integrator FileIO DataOutput Utilities NodeGenerators SimulationControl SPH CRKSPH FVCRKH SVPH Mesh Damage SolidMaterial Strength ArtificialConduction $CXXPKGS"
   CXXPKGLIBS="Geometry NodeList Field FieldOperations Kernel Material Neighbor DataBase Boundary Physics ArtificialViscosity Hydro ExternalForce Gravity Integrator FileIO DataOutput Utilities NodeGenerators SPH CRKSPH FVCRKH SVPH Mesh Damage SolidMaterial Strength ArtificialConduction $CXXPKGLIBS"
   GEOMETRY_ONLY=0
])
