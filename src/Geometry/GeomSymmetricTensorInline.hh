...
inline
double
GeomSymmetricTensor<1>::xy() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<1>::xz() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<2>::xz() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<3>::xz() const {
  return this->mxz;
}
...
inline
double
GeomSymmetricTensor<1>::yx() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<2>::yx() const {
  return this->mxy;
}
...
inline
double
GeomSymmetricTensor<3>::yx() const {
  return this->mxy;
}
...
inline
double
GeomSymmetricTensor<1>::yy() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<2>::yy() const {
  return this->myy;
}
...
inline
double
GeomSymmetricTensor<3>::yy() const {
  return this->myy;
}
...
inline
double
GeomSymmetricTensor<1>::yz() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<2>::yz() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<3>::yz() const {
  return this->myz;
}
...
inline
double
GeomSymmetricTensor<1>::zx() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<2>::zx() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<3>::zx() const {
  return this->mxz;
}
...
inline
double
GeomSymmetricTensor<1>::zy() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<2>::zy() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<3>::zy() const {
  return this->myz;
}
...
inline
double
GeomSymmetricTensor<1>::zz() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<2>::zz() const {
  return 0.0;
}
...
inline
double
GeomSymmetricTensor<3>::zz() const {
  return this->mzz;
}
...
inline
void
GeomSymmetricTensor<1>::xy(const double val) {
}
...
inline
void
GeomSymmetricTensor<1>::xz(const double val) {
}

template<>
inline
void
GeomSymmetricTensor<2>::xz(const double val) {
}

template<>
inline
void
GeomSymmetricTensor<3>::xz(const double val) {
  this->mxz = val;
}
...
inline
void
GeomSymmetricTensor<1>::yx(const double val) {
}

template<>
inline
void
GeomSymmetricTensor<2>::yx(const double val) {
  this->mxy = val;
}
...
inline
void
GeomSymmetricTensor<3>::yx(const double val) {
  this->mxy = val;
}
...
inline
void
GeomSymmetricTensor<1>::yy(const double val) {
}

template<>
inline
void
GeomSymmetricTensor<2>::yy(const double val) {
  this->myy = val;
}
...
inline
void
GeomSymmetricTensor<3>::yy(const double val) {
  this->myy = val;
}
...
inline
void
GeomSymmetricTensor<1>::yz(const double val) {
}

template<>
inline
void
GeomSymmetricTensor<2>::yz(const double val) {
}

template<>
inline
void
GeomSymmetricTensor<3>::yz(const double val) {
  this->myz = val;
}
...
inline
void
GeomSymmetricTensor<1>::zx(const double val) {
}

template<>
inline
void
GeomSymmetricTensor<2>::zx(const double val) {
}

template<>
inline
void
GeomSymmetricTensor<3>::zx(const double val) {
  this->mxz = val;
}
...
inline
void
GeomSymmetricTensor<1>::zy(const double val) {
}

template<>
inline
void
GeomSymmetricTensor<2>::zy(const double val) {
}

template<>
inline
void
GeomSymmetricTensor<3>::zy(const double val) {
  this->myz = val;
}
...
inline
void
GeomSymmetricTensor<1>::zz(const double val) {
}

template<>
inline
void
GeomSymmetricTensor<2>::zz(const double val) {
}

template<>
inline
void
GeomSymmetricTensor<3>::zz(const double val) {
  this->mzz = val;
}
...
doubledot(const GeomTensor<2>& rhs) const {
  return ((this->mxx)*(rhs.xx()) + (this->mxy)*(rhs.xy()) +
          (this->mxx)*(rhs.xy()) + (this->mxy)*(rhs.yy()) +
          (this->mxy)*(rhs.xx()) + (this->myy)*(rhs.xy()) +
          (this->mxy)*(rhs.xy()) + (this->myy)*(rhs.yy()));
}
...
doubledot(const GeomTensor<3>& rhs) const {
  return ((this->mxx)*rhs.xx() + (this->mxy)*rhs.xy() + (this->mxz)*rhs.xz() +
          (this->mxx)*rhs.xy() + (this->mxy)*rhs.yy() + (this->mxz)*rhs.yz() +
          (this->mxx)*rhs.xz() + (this->mxy)*rhs.yz() + (this->mxz)*rhs.zz() +
          (this->mxy)*rhs.xx() + (this->myy)*rhs.xy() + (this->myz)*rhs.xz() +
          (this->mxy)*rhs.xy() + (this->myy)*rhs.yy() + (this->myz)*rhs.yz() +
          (this->mxy)*rhs.xz() + (this->myy)*rhs.yz() + (this->myz)*rhs.zz() +
          (this->mxz)*rhs.xx() + (this->myz)*rhs.xy() + (this->mzz)*rhs.xz() +
          (this->mxz)*rhs.xy() + (this->myz)*rhs.yy() + (this->mzz)*rhs.yz() +
          (this->mxz)*rhs.xz() + (this->myz)*rhs.yz() + (this->mzz)*rhs.zz());
}
...
selfDoubledot() const {
  return ((this->mxx)*(this->mxx) + (this->mxy)*(this->mxy) +
          ...
          (this->mxy)*(this->mxx) + (this->myy)*(this->mxy) +
...
selfDoubledot() const {
  return ((this->mxx)*(this->mxx) + (this->mxy)*(this->mxy) + (this->mxz)*(this->mxz) +
          (this->mxx)*(this->mxy) + (this->mxy)*(this->myy) + (this->mxz)*(this->myz) +
          (this->mxx)*(this->mxz) + (this->mxy)*(this->myz) + (this->mxz)*(this->mzz) +
          (this->mxy)*(this->mxx) + (this->myy)*(this->mxy) + (this->myz)*(this->mxz) +
          (this->mxy)*(this->mxy) + (this->myy)*(this->myy) + (this->myz)*(this->myz) +
          (this->mxy)*(this->mxz) + (this->myy)*(this->myz) + (this->myz)*(this->mzz) +
          (this->mxz)*(this->mxx) + (this->myz)*(this->mxy) + (this->mzz)*(this->mxz) +
          (this->mxz)*(this->mxy) + (this->myz)*(this->myy) + (this->mzz)*(this->myz) +
