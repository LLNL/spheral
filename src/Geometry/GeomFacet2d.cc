...
GeomFacet2d(const std::vector<GeomFacet2d::Vector>& vertices,
  ...
  REQUIRE2(fuzzyEqual((this->point2() - this->point1()).unitVector().dot(mNormal.unitVector()), 0.0, 1.0e-6),
           "ERROR with orthogonal face normal: " << this->point1() << " " << this->point2() << " " << mNormal << " " << (this->point2() - this->point1()).unitVector().dot(mNormal.unitVector()));
