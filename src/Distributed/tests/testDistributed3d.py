#ATS:test(SELF, np=8, label="NestedGridDistributedBoundary (3-D) unit tests")
import unittest
import random
import mpi
...
class TestDistributedBoundary3d:
    ...
    #===========================================================================
    def testIt(self):
        print "Testing NestedGridDistributedBoundary3d on domain %i of %i domains" % \
              (domainID, numDomains)
...
#===============================================================================
class TestNestedGridDistributedBoundary3d(unittest.TestCase,
                                          TestDistributedBoundary3d):

    # Set up method called before test is run.
    def setUp(self):
        self.domainbc = NestedGridDistributedBoundary3d.instance()
        self.genericSetup()
