...
const std::string Spheral::SolidFieldNames::numFlawsActivated = "num flaws activated";
const std::string Spheral::SolidFieldNames::currentFlaw = "current flaw";
const std::string Spheral::SolidFieldNames::initialVolume = "initial volume";
const std::string Spheral::SolidFieldNames::randomGenerators = "random generators";
