...
const std::string Spheral::SolidFieldNames::effectiveTensorDamage = "effective tensor damage";
const std::string Spheral::SolidFieldNames::damageGradient = "damage gradient";
const std::string Spheral::SolidFieldNames::damageHat = "damage direction";
...
const std::string Spheral::SolidFieldNames::effectiveFlaws = "effective flaws";
