...
class FileIOTestBase:
    ...
    def testInt(self):
        ...
        f.write(x0, "FileIOTestBase/TestInt")
        f.close()
        f = self.constructor("TestInt", Read)
        x1 = f.read_int("FileIOTestBase/TestInt")
        print "READ INT : %i vs %i" % (x0, x1)
        f.close()
...
#         f.write(x0, "FileIOTestBase/TestFloat")
#         f.close()
...
#         f.write(x0, "FileIOTestBase/TestString")
#         f.close()
