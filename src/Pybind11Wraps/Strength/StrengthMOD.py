...
class SolidFieldNames:
    ...
    numFlawsActivated = PYB11readonly(static=True, returnpolicy="copy")
    currentFlaw = PYB11readonly(static=True, returnpolicy="copy")
    initialVolume = PYB11readonly(static=True, returnpolicy="copy")
    randomGenerators = PYB11readonly(static=True, returnpolicy="copy")
