...
class SolidFieldNames:
    ...
    effectiveTensorDamage = PYB11readonly(static=True, returnpolicy="copy")
    damageGradient = PYB11readonly(static=True, returnpolicy="copy")
    damageHat = PYB11readonly(static=True, returnpolicy="copy")
