...
#
##    @PYB11const
##    @PYB11implementation('[](FieldViewType& self) -> std::string { return self.get().name(); }')
##    def name(self):
##        "Get Field Name"
##        return "py::bytes"
##
...
##        return "void"
#
#    name = PYB11property(getterraw="[](FieldViewType& self) { return self.get().name(); }",
#                         setterraw="[](FieldViewType& self, std::string s) { self.get().name(s); }",
#                         doc="Name for the FieldView/Field.")
