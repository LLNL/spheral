...
class SuperiorRKCorrections(Physics):
...
# Inject methods
#-------------------------------------------------------------------------------
PYB11inject(PhysicsAbstractMethods, SuperiorRKCorrections, virtual=True)
PYB11inject(RestartMethods, SuperiorRKCorrections)
