...
void dimensionBindings(py::module& m, const std::string suffix) {
  ...
  py::class_<DB>(m, ("DataBase" + suffix).c_str(), py::metaclass())
    ...
    .def("appendNodeList", (void (DB::*)(SolidMaterial::SolidNodeList<Dimension>&)) &DB::appendNodeList, "nodeList"_a)
    ...
    .def("deleteNodeList", (void (DB::*)(SolidMaterial::SolidNodeList<Dimension>&)) &DB::deleteNodeList, "nodeList"_a)
