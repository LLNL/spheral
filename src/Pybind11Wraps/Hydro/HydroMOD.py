...
class HydroFieldNames:
    ...
    A_RK = PYB11readonly(static=True)
    B_RK = PYB11readonly(static=True)
    C_RK = PYB11readonly(static=True)
    D_RK = PYB11readonly(static=True)
    gradA_RK = PYB11readonly(static=True)
    gradB_RK = PYB11readonly(static=True)
    gradC_RK = PYB11readonly(static=True)
    gradD_RK = PYB11readonly(static=True)
    hessA_RK = PYB11readonly(static=True)
