...
namespace Spheral {
  ...
  template void computeMFMDensity(const FieldList<Dim<1>, Dim<1>::Scalar>&,
  ...
  template void computeMFMDensity(const FieldList<Dim<2>, Dim<2>::Scalar>&,
  ...
  template void computeMFMDensity(const FieldList<Dim<3>, Dim<3>::Scalar>&,
