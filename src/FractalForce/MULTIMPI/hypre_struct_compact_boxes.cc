...
{
  void hypre_struct_compact_boxes(vector <Point*>& p_points_left,vector <Point*>& p_points_right,
				  vector <Point*>& p_points_left_big,vector <Point*>& p_points_right_big,
				  Fractal& fractal,Fractal_Memory& mem,const int& level)
  {
