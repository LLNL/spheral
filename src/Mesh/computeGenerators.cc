...
cerr << "Computing and broadcasting local hulls of domains." << endl;
...
//     if (Process::getRank() == 0) 
cerr << "computeGenerators:  Computing mesh of union of local hulls." << endl;
...
//     if (Process::getRank() == 0) 
cerr << "computeGenerators:  Checking for hulls that intersect local." << endl;
...
//     if (Process::getRank() == 0) 
cerr << "computeGenerators:  Checking for hulls adjacent in mesh." << endl;
...
//     if (Process::getRank() == 0) 
cerr << "computeGenerators:  Sending local generators to neighbors." << endl;
...
//       if (Process::getRank() == 0) 
cerr << "    computeGenerators:  " << Process::getRank() << "->" << otherProc << " sending " << sendGenIDs.size() << " of " << localPositions.size() << endl;
...
//     if (Process::getRank() == 0) 
cerr << "computeGenerators:  Receiving neighbor generators." << endl;
    for (unsigned k = 0; k != neighborDomains.size(); ++k) {
...
//     if (Process::getRank() == 0) 
cerr << "computeGenerators:  Done." << endl;
