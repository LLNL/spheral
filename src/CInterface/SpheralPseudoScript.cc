...
//------------------------------------------------------------------------------
// dtNode -- query to get the node ID which is controlling the time step
...
dtNode() {
  // Get our instance.
  auto& me = SpheralPseudoScript<Dimension>::instance();
  size_t localNode = me.mHydroPtr->DTnode();
  return localNode;
}

//------------------------------------------------------------------------------
// dtReason -- query to get the reason Spheral is controlling the time step
// Returns:    the string describing the time step constraint
//------------------------------------------------------------------------------
template<typename Dimension>
std::string
SpheralPseudoScript<Dimension>::
dtReason() {
  // Get our instance.
  auto& me = SpheralPseudoScript<Dimension>::instance();
  std::string localReason = me.mHydroPtr->DTreason();
  return localReason;
}
