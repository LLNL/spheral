...
class ReplaceBoundedFieldList(FieldListUpdatePolicyBase):

    PYB11typedefs = """
    using KeyType = typename ReplaceBoundedFieldList<%(Dimension)s, %(ValueType)s>::KeyType;
"""
    ...
    @PYB11static
    def prefix(self):
        "Prefix for key of new value"
        return "const std::string"

    #...........................................................................
    # Properties
    minValue = PYB11property(doc="Minimum bound for FieldList values")
    maxValue = PYB11property(doc="Maximum bound for FieldList values")
