...
if 1 in dims:
    ...
    computeSPHSumMassDensity1d_spherical = PYB11TemplateFunction(computeSPHSumMassDensity, template_parameters=("Dim<1>", "SphericalKernelOslo"), pyname="computeSPHSumMassDensity1d")
