...
::
  ...
  toss_3_x86_64_ib-gcc~mpi.cmake
...
The CMake command ``-C ../../Spheral/toss_3_x86_64_ib-gcc.cmake`` is how we tell the Spheral CMake system to use the TPLs we installed with ``tpl-manager.py`` for ``gcc``.
