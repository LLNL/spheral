...
/*
 * Test case for the GeomVector constructor.
...
/*
 * Test case for the GeomVector assignment operators.
 * This test verifies that both scalar and vector assignment work correctly.
 ...
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, Assignment) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
    Vector v;
    v = 5.0;
...
/*
 * Test case for the GeomVector element accessors.
 * This test verifies that the parenthesis and square bracket operators
 * correctly access and modify vector components. It asserts that `v(i)` and
 * `v[i]` return the correct values, and then modifies components using these
 * accessors and asserts the new values.
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, Accessors) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
    Vector v(1.0, 2.0, 3.0);
...
/*
 * Test case for the GeomVector component setters.
 ...
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, Setters) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
    Vector v;
    v.x(1.0);
...
/*
 * Test case for the GeomVector's Zero() method.
 ...
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, Zero) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
    Vector v(1.0, 2.0, 3.0);
    v.Zero();
...
/*
 * Test case for the GeomVector unary minus operator.
 ...
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, UnaryMinus) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
...
/*
 * Test case for GeomVector addition and subtraction.
 ...
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, AddSub) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
    Vector v1(1.0, 2.0, 3.0);
...
/*
 * Test case for GeomVector scalar multiplication and division.
 ...
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, ScalarMulDiv) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
    Vector v(1.0, 2.0, 3.0);
    double s = 2.0;
...
/*
 * Test case for GeomVector in-place addition and subtraction.
 ...
 * components of `v1`.
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, InPlaceAddSub) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
    Vector v1(1.0, 2.0, 3.0);
    Vector v2(4.0, 5.0, 6.0);
...
/*
 * Test case for GeomVector in-place scalar multiplication and division.
 * This test verifies that the `*=` and `/=` operators produce the correct
 * results. It asserts that `v *= s` and `v /= s` correctly modify the
 * components of `v`.
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, InPlaceScalarMulDiv) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
    Vector v(1.0, 2.0, 3.0);
    double s = 2.0;
...
/*
 * Test case for the GeomVector dot product.
 ...
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, Dot) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
    Vector v1(1.0, 2.0, 3.0);
    Vector v2(4.0, 5.0, 6.0);
...
/*
 * Test case for the GeomVector cross product.
 ...
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, Cross) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
...
/*
 * Test case for the GeomVector magnitude.
 ...
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, Magnitude) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
...
/*
 * Test case for the GeomVector unit vector.
 ...
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, UnitVector) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
    Vector v(3.0, 4.0, 0.0);
...
/*
 * Test case for the GeomVector element-wise statistics.
 * This test verifies that the `minElement`, `maxElement`, `maxAbsElement`, and
 ...
 */
GPU_TYPED_TEST_P(GeomVectorTypedTest, ElementStats) {
  using WORK_EXEC_POLICY = TypeParam;
  EXEC_IN_SPACE_BEGIN(WORK_EXEC_POLICY)
    Vector v(-1.0, 2.0, -3.0);
    SPHERAL_ASSERT_EQ(v.minElement(), -3.0);
    SPHERAL_ASSERT_EQ(v.maxElement(), 2.0);
    SPHERAL_ASSERT_EQ(v.maxAbsElement(), 3.0);
    SPHERAL_ASSERT_EQ(v.sumElements(), -2.0);
  EXEC_IN_SPACE_END()
}

REGISTER_TYPED_TEST_SUITE_P(GeomVectorTypedTest, Ctor, Assignment, Accessors,
