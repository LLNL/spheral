...
GPU_TYPED_TEST_P(FieldTypedTest, SPtrCopy)
{
...

  {
    ...
    std::shared_ptr<FieldDouble> copy_field = std::make_shared<FieldDouble>(field);
    std::shared_ptr<FieldDouble> copy_field2 = std::make_shared<FieldDouble>(*copy_field.get());
