...
set title "2-D Planar Noh pressure convergence"
set xlabel "N"
set ylabel "Error"
...
replot "Noh-planar-convergence-test.txt-asph" using 1:5 t "L1, ASPH"
replot "Noh-planar-convergence-test.txt-asph" using 1:6 t "L2, ASPH"
replot "Noh-planar-convergence-test.txt-asph" using 1:7 t "Linf, ASPH"
...
logfL11(x) = A11 + m11*x
fit logfL11(x) "Noh-planar-convergence-test.txt-asph" using (log10($1)):(log10($5)) via A11, m11
fL11(x) = 10.0**A11 * x**m11
replot fL11(x) t "L1 fit, ASPH"

logfL21(x) = A21 + m21*x
fit logfL21(x) "Noh-planar-convergence-test.txt-asph" using (log10($1)):(log10($6)) via A21, m21
fL21(x) = 10.0**A21 * x**m21
replot fL21(x) t "L2 fit, ASPH"

logfLinf1(x) = Ainf1 + minf1*x
fit logfLinf1(x) "Noh-planar-convergence-test.txt-asph" using (log10($1)):(log10($7)) via Ainf1, minf1
