...
set title "1-D Planar Noh smoothing scale convergence"
set xlabel "N"
set ylabel "Error"
...
replot "Noh-planar-convergence-test.txt-XSPH" using 1:14 t "L1, XSPH"
replot "Noh-planar-convergence-test.txt-XSPH" using 1:15 t "L2, XSPH"
replot "Noh-planar-convergence-test.txt-XSPH" using 1:16 t "Linf, XSPH"
...
logfL11(x) = A11 + m11*x
fit logfL11(x) "Noh-planar-convergence-test.txt-XSPH" using (log10($1)):(log10($14)) via A11, m11
fL11(x) = 10.0**A11 * x**m11
replot fL11(x) t "L1 fit, XSPH"

logfL21(x) = A21 + m21*x
fit logfL21(x) "Noh-planar-convergence-test.txt-XSPH" using (log10($1)):(log10($15)) via A21, m21
fL21(x) = 10.0**A21 * x**m21
replot fL21(x) t "L2 fit, XSPH"

logfLinf1(x) = Ainf1 + minf1*x
fit logfLinf1(x) "Noh-planar-convergence-test.txt-XSPH" using (log10($1)):(log10($16)) via Ainf1, minf1
