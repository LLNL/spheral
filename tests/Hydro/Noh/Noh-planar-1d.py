...
# Solid FSISPH
#
#ATS:t400 = test(        SELF, "--fsisph True --solid True --graphics None --clearDirectories True --checkError True --restartStep 20 --steps 40", label="Planar Noh problem with FSISPH -- 1-D (serial)")
