...
commandLine(nx1 = 100,
            ...
            nx2 = 100,
            ny2 = 50,
            y0 = 1.0,       # position of the interface
            rho0 = 1.0,
            eps0 = 1.0,
            P1 = 2.5,
            P2 = 2.5,
            ...
            vx2 = 0.0,
            freq = 1.0,
            alpha = 0.05,   # amplitude of displacement
...
if restoreCycle is None:
    ...
    def dy(ri):
        thpt = alpha*cos(2*pi*ri.x*freq)
        return thpt*exp(-beta*abs(ri.y-y0))
    def Pr(ri):
        thpt = -g0*(-1.0-ri.y)
...
yp2 = Plane(Vector(0.0, 2.0), Vector(0.0, -1.0))
