...
#
#ATS:test(SELF, "--steps 100 --compatibleEnergy False --clearDirectories True --baseDir 3D_1proc_ref --siloSnapShotFile Spheral_state_snapshot_1proc", np=1, label="Generate 1 proc reference data")
#ATS:test(SELF, "--steps 100 --compatibleEnergy False --clearDirectories True --baseDir 3D_8proc_ref --siloSnapShotFile Spheral_state_snapshot_8proc", np=8, label="Generate 8 proc reference data")
