...
del nodes
'''
output("innerNodes.name")
output("    innerNodes.hmin")
output("    innerNodes.hmax")
output("    innerNodes.hminratio")
output("    innerNodes.nodesPerSmoothingScale")
