#ATS:test(SELF, np=8, label="PametisRedistribute unit tests")
from math import *
import unittest
...
#===============================================================================
class TestParmetisRedistribute2d(TestDistributeByPosition2d):
    ...
    def testIt(self):
        ...
        repartition = ParmetisRedistributeNodes2d(2.0)
...
#===============================================================================
class TestParmetisRedistribute3d(unittest.TestCase):
    ...
    def testIt(self):
        ...
        # Go ahead and redistribute those nodes!
        repartition = ParmetisRedistributeNodes3d(2.0)
        repartition.redistributeNodes(self.dataBase)
