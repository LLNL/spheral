#ATS:test(SELF, np=8, label="MortonOrderRedistribute unit tests")
from math import *
import unittest
...
#===============================================================================
class TestMortonOrderRedistribute2d(TestDistributeByPosition2d):

    # The actual test itself!
    # Create a MortonOrderRedistributeNodes object, have it redistribute the
    # nodes.
    def testIt(self):
        print("Testing MortonOrderRedistributeNodes2d on domain %i of %i domains" % \
              (domainID, nDomains))
...
##                                     persist = True)
        ...
        repartition = MortonOrderRedistributeNodes2d(2.0)
...
#===============================================================================
class TestMortonOrderRedistribute3d(unittest.TestCase):
    ...
    # nodes.
    def testIt(self):
        print("Testing MortonOrderRedistributeNodes3d on domain %i of %i domains" % \
              (domainID, nDomains))
        ...
        # Go ahead and redistribute those nodes!
        repartition = MortonOrderRedistributeNodes3d(2.0)
        repartition.redistributeNodes(self.dataBase)
