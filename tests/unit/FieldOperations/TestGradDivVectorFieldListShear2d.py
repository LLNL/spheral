...
dx1 = (rmax1[0] - rmin1[0])/nx1
dx2 = (rmax2[0] - rmin2[0])/nx2
for i in xrange(nodes1.numNodes):
    nodes1.positions[i].x += offset1*dx1
for i in xrange(nodes2.numNodes):
    nodes2.positions[i].x += offset2*dx2
...
for nodeID in xrange(nodes1.numNodes):
    nodes1.velocity[nodeID] = (vx1, vy1)
for nodeID in xrange(nodes2.numNodes):
    nodes2.velocity[nodeID] = (vx2, vy2)
...
#W = BSplineKernel2d()
#W = W4SplineKernel2d()
#W = GaussianKernel2d(3)
#W = SuperGaussianKernel2d()
#W = PiGaussianKernel2d(1.0)
#W = NSincPolynomialKernel2d(5)
#W = NSincPolynomialKernel2d(7)
#W = QuarticSplineKernel2d()
W = NBSplineKernel2d(9)
output('W')
...
plotDirect = plotVectorField2d(db, directGradDivVel, vectorMultiplier=5e-1,
...
# plotSimple = plotVectorField2d(db, simpleGradDivVel, vectorMultiplier=5e-1,
...
plotGolden = plotVectorField2d(db, goldenGradDivVel, vectorMultiplier=5e-1,
...
# plotMash = plotVectorField2d(db, mashGradDivVel, vectorMultiplier=5e-1,
