...
\begin{verbatim}
./configure --with-opt=3 --with-dbc=none --prefix=/usr/local/Spheral/cxx
make cxxonly \
     EXTRAINCLUDES='-I TPL_TOP/include -I TPL/WildMagic5/Include \
     EXTRALIBS='-L TPL_TOP/lib -L TPL_TOP/WildMagic5/Library/ReleaseDynamic'
\end{verbatim}
