...
By default \Spheral\ builds instantiations of all the dimensionalities it knows
about (currently 1D, 2D, and 3D).  It is possible to selectively turn off any of
those instantiations at configure time with the configure options
\verb.--without-1d., \verb.--without-2d., and/or \verb.--without-3d..
