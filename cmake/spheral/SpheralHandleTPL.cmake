...
function(Spheral_Handle_TPL lib_name dep_list target_type)
  ...
  # Build up the includes and libraries for non-BLT targets (like pybind11)
  ...
  list(APPEND spheral_tpl_includes ${${lib_name}_INCLUDES})
  list(APPEND spheral_tpl_libraries ${${lib_name}_LIBRARIES})
  set_property(GLOBAL PROPERTY spheral_tpl_includes ${spheral_tpl_includes})
  set_property(GLOBAL PROPERTY spheral_tpl_libraries ${spheral_tpl_libraries})
