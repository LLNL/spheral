...
RUN cd spheral_release/build && cmake -DCMAKE_CXX_COMPILER=g++ -DENABLE_WARNINGS=On ../../ -DCMAKE_INSTALL_PREFIX="../install"
#RUN cd spheral_release/build && make -j 16
#RUN cd spheral_release/build && ctest -T test --output-on-failure
