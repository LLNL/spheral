...
class Lvarray(CMakePackage, CudaPackage):
    ...
    homepage = "https://github.com/mdavis36/lvarray"
    git      = "https://github.com/mdavis36/LvArray.git"
    tags     = ['radiuss']

    maintainers = ['corbett5']

    version('develop', branch='bump-blt', submodules=False)
    ...
    depends_on('blt@0.5:', when='@0.2.0:', type='build')
